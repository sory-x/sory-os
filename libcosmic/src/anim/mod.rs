//! Animation primitives for fluid, modern UIs.
//!
//! Provides easing functions, spring physics, generic tweening,
//! and animation frame subscriptions — all without breaking the
//! existing `lerp`, `slerp`, `smootherstep`, and `State` API.
