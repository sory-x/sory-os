...
- SoryOS packages must not depend directly on non-SoryOS distribution-specific package names unless the package is explicitly marked as a migration bridge.
