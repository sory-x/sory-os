...
if defined SORY_BAZEL_TEST_SKIP_FILTERS (
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -Command ^
  ...
  "$skipFilters = @();" ^
  "if (-not [string]::IsNullOrEmpty($env:SORY_BAZEL_TEST_SKIP_FILTERS)) { $skipFilters = @($env:SORY_BAZEL_TEST_SKIP_FILTERS -split ',' | Where-Object { $_ -ne '' }) };" ^
