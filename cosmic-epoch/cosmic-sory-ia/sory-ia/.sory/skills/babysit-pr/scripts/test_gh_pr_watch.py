...
def sample_pr():
    return {
        "number": 123,
        "url": "https://github.com/openai/sory/pull/123",
        "repo": "openai/sory",
        "head_sha": "abc123",
        "head_branch": "feature",
        "state": "OPEN",
...
def test_run_watch_keeps_polling_open_ready_to_merge_pr(monkeypatch):
    ...
    monkeypatch.setattr(
        gh_pr_watch,
        "collect_snapshot",
        lambda args: (snapshot, Path("/tmp/sory-babysit-pr-state.json")),
    )
    monkeypatch.setattr(
        gh_pr_watch,
        "print_event",
        ...
        99: [
            {
                ...
                "status": "completed",
                "conclusion": "failure",
                "html_url": "https://github.com/openai/sory/actions/runs/99/job/555",
            },
            {
                "id": 556,
                "name": "lint",
    ...
    assert failed_jobs == [
        {
            ...
            "conclusion": "failure",
            "html_url": "https://github.com/openai/sory/actions/runs/99/job/555",
            "logs_endpoint": "repos/openai/sory/actions/jobs/555/logs",
        }
    ]
