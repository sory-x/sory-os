...
fn failed_turn_does_not_overwrite_output_last_message_file() {
    ...
    let status = processor.process_server_notification(ServerNotification::TurnCompleted(
        sory_app_server_protocol::TurnCompletedNotification {
            ...
            turn: sory_app_server_protocol::Turn {
                ...
                error: Some(sory_app_server_protocol::TurnError {
    ...
    assert_eq!(status, soryStatus::InitiateShutdown);
    ...
    let collected = processor.collect_thread_events(ServerNotification::ItemCompleted(
        sory_app_server_protocol::ItemCompletedNotification {
            item: ThreadItem::McpToolCall {
                ...
                arguments: json!({"search_query": [{"q": "OpenAI sory CLI documentation"}]}),
                mcp_app_resource_uri: None,
                result: Some(Box::new(sory_app_server_protocol::McpToolCallResult {
