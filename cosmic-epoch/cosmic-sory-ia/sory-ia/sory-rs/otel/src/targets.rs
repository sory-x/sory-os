pub(crate) const OTEL_TARGET_PREFIX: &str = "sory_otel";
pub(crate) const OTEL_LOG_ONLY_TARGET: &str = "sory_otel.log_only";
pub(crate) const OTEL_TRACE_SAFE_TARGET: &str = "sory_otel.trace_safe";
