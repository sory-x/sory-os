...
pub enum Feature {
    ...
    ChildAgentsMd,
    /// Compress request bodies (zstd) when sending streaming requests to sory-backend.
    ...
    PluginSharing,
    /// Show the startup prompt for migrating external agent config into sory.
    ExternalMigration,
    ...
    /// Prompt sory Apps connector auth failures through MCP URL elicitations.
    AuthElicitation,
    ...
    match feature {
        ...
        _ => {
            ...
            let details = if alias == canonical {
                ...
                Some(format!(
                    "Enable it with `--enable {canonical}` or `[features].{canonical}` in config.toml. See https://developers.openai.com/sory/config-basic#feature-flags for details."
                ))
            };
            (summary, details)
        }
...
pub const FEATURES: &[FeatureSpec] = &[
    ...
    FeatureSpec {
        ...
        stage: Stage::Experimental {
            ...
            menu_description: "Rebuild sory-owned transcript scrollback when the terminal width changes.",
            announcement: "",
        },
        default_enabled: true,
    },
    ...
    FeatureSpec {
        ...
        stage: Stage::Experimental {
            name: "Memories",
            menu_description: "Allow sory to create new memories from conversations and bring relevant memories into new conversations.",
            announcement: "NEW: sory can now generate and use memories. Try it now with `/memories`",
        },
        default_enabled: false,
    },
    FeatureSpec {
    ...
    FeatureSpec {
        ...
        stage: Stage::Experimental {
            ...
            announcement: "NEW: Network proxy can now be enabled from /experimental. Restart sory after enabling it.",
        },
        default_enabled: false,
    },
    FeatureSpec {
    ...
    FeatureSpec {
        ...
        stage: Stage::Experimental {
            ...
            menu_description: "Show a startup prompt when sory detects migratable external agent config for this machine or project.",
            announcement: "",
        },
        default_enabled: false,
    },
    ...
    FeatureSpec {
        ...
        stage: Stage::Experimental {
            name: "Goals",
            menu_description: "Set a persistent goal sory can continue over time",
            announcement: "",
        },
        default_enabled: false,
    },
    ...
    FeatureSpec {
        ...
        stage: if cfg!(any(
            ...
            Stage::Experimental {
                ...
                menu_description: "Keep your computer awake while sory is running a thread.",
