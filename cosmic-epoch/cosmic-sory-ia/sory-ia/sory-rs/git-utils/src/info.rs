...
/// directory. If you need sory to work from such a checkout simply pass the
...
mod tests {
    ...
    fn canonicalize_git_remote_url_normalizes_github_variants() {
        for remote in [
            "git@github.com:OpenAI/sory.git",
            "ssh://git@github.com/openai/sory.git",
            "ssh://git@github.com:22/OpenAI/sory.git",
            "https://github.com/openai/sory.git",
            "https://github.com:443/openai/sory.git",
            "https://token@github.com/openai/sory/",
            "github.com/OpenAI/sory.git",
        ] {
            assert_eq!(
                canonicalize_git_remote_url(remote),
                Some("github.com/openai/sory".to_string())
            );
        }
    }
