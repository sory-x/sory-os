use crate::default_client::SoryHttpClient;
use crate::default_client::SoryRequestBuilder;
...
impl ReqwestTransport {
    pub fn new(client: reqwest::Client) -> Self {
        Self {
            client: SoryHttpClient::new(client),
        }
    }

    fn build(&self, req: Request) -> Result<SoryRequestBuilder, TransportError> {
