...
impl SkillsManager {
    pub fn new(sory_home: AbsolutePathBuf, bundled_skills_enabled: bool) -> Self {
        Self::new_with_restriction_product(sory_home, bundled_skills_enabled, Some(Product::Sory))
    }
    ...
    pub fn new_with_restriction_product(
        ...
        if !bundled_skills_enabled {
            ...
            uninstall_system_skills(&manager.sory_home);
        } else if let Err(err) = install_system_skills(&manager.sory_home) {
...
pub fn bundled_skills_enabled_from_stack(
    config_layer_stack: &sory_config::ConfigLayerStack,
) -> bool {
