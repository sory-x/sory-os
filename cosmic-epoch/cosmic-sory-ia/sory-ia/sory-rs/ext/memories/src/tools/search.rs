...
use serde_json::json;
use sory_extension_api::JsonToolOutput;
use sory_extension_api::ToolCall;
use sory_extension_api::ToolExecutor;
use sory_extension_api::ToolName;
use sory_extension_api::ToolSpec;
    ...
    B: MemoriesBackend,
{
    ...
    async fn handle(
        &self,
        call: ToolCall,
    ) -> Result<Box<dyn sory_extension_api::ToolOutput>, sory_extension_api::FunctionCallError>
    {
