...
pub(super) const REMOTE_CONTROL_INSTALLATION_ID_HEADER: &str = "x-sory-installation-id";
const REMOTE_CONTROL_SUBSCRIBE_CURSOR_HEADER: &str = "x-sory-subscribe-cursor";
...
fn build_remote_control_websocket_request(
    ...
    set_remote_control_header(headers, "x-sory-server-id", &enrollment.server_id)?;
...
pub(crate) async fn load_remote_control_auth(
    ...
    Ok(RemoteControlConnectionAuth {
        auth_provider: sory_model_provider::auth_provider_from_auth(&auth),
