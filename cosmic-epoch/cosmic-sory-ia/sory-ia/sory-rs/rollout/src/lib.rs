//! Rollout persistence and discovery for sory session files.
...
pub(crate) mod default_client {
    pub use sory_login::default_client::*;
}

pub(crate) use sory_protocol::protocol;
...
pub use sory_protocol::protocol::SessionMeta;
