...
use sory_app_server_protocol::Model;
use sory_app_server_protocol::ModelListParams;
use sory_app_server_protocol::ModelListResponse;
use sory_app_server_protocol::ModelServiceTier;
use sory_app_server_protocol::ModelUpgradeInfo;
use sory_app_server_protocol::ReasoningEffortOption;
...
fn expected_visible_models() -> Vec<Model> {
    ...
    let mut presets = ModelPreset::filter_by_auth(
        sory_core::test_support::all_model_presets().clone(),
        /*chatgpt_mode*/ false,
    );
