...
use serde_json::json;
use sory_app_server_protocol::AppBranding;
use sory_app_server_protocol::AppInfo;
use sory_app_server_protocol::AppListUpdatedNotification;
use sory_app_server_protocol::AppMetadata;
use sory_app_server_protocol::AppReview;
use sory_app_server_protocol::AppScreenshot;
...
#[tokio::test]
async fn list_apps_returns_empty_when_workspace_sory_plugins_disabled() -> Result<()> {
    let connectors = vec![AppInfo {
        id: "beta".to_string(),
        name: "Beta".to_string(),
        description: Some("Beta connector".to_string()),
