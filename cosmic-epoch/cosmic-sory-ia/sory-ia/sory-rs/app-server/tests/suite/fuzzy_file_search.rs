...
use serde_json::json;
use sory_app_server_protocol::FuzzyFileSearchSessionCompletedNotification;
use sory_app_server_protocol::FuzzyFileSearchSessionUpdatedNotification;
...
async fn test_fuzzy_file_search_sorts_and_includes_indices() -> Result<()> {
    // Prepare a temporary sory home and a separate root with test files.
