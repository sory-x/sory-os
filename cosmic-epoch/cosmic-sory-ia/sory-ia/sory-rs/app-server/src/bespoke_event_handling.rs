...
use sory_app_server_protocol::AccountRateLimitsUpdatedNotification;
use sory_app_server_protocol::AdditionalPermissionProfile as V2AdditionalPermissionProfile;
use sory_app_server_protocol::SoryErrorInfo as V2soryErrorInfo;
use sory_app_server_protocol::CommandAction as V2ParsedCommand;
use sory_app_server_protocol::CommandExecutionApprovalDecision;
use sory_app_server_protocol::CommandExecutionRequestApprovalParams;
use sory_app_server_protocol::CommandExecutionRequestApprovalResponse;
use sory_app_server_protocol::CommandExecutionSource;
use sory_app_server_protocol::CommandExecutionStatus;
use sory_app_server_protocol::DeprecationNoticeNotification;
use sory_app_server_protocol::DynamicToolCallParams;
use sory_app_server_protocol::DynamicToolCallStatus;
use sory_app_server_protocol::ErrorNotification;
use sory_app_server_protocol::ExecPolicyAmendment as V2ExecPolicyAmendment;
use sory_app_server_protocol::FileChangeApprovalDecision;
use sory_app_server_protocol::FileChangeRequestApprovalParams;
use sory_app_server_protocol::FileChangeRequestApprovalResponse;
use sory_app_server_protocol::GrantedPermissionProfile as V2GrantedPermissionProfile;
use sory_app_server_protocol::GuardianWarningNotification;
use sory_app_server_protocol::HookCompletedNotification;
use sory_app_server_protocol::HookStartedNotification;
use sory_app_server_protocol::ItemCompletedNotification;
use sory_app_server_protocol::ItemStartedNotification;
use sory_app_server_protocol::McpServerElicitationAction;
use sory_app_server_protocol::McpServerElicitationRequestParams;
use sory_app_server_protocol::McpServerElicitationRequestResponse;
use sory_app_server_protocol::McpServerStartupState;
use sory_app_server_protocol::McpServerStatusUpdatedNotification;
use sory_app_server_protocol::ModelReroutedNotification;
use sory_app_server_protocol::ModelVerificationNotification;
use sory_app_server_protocol::NetworkApprovalContext as V2NetworkApprovalContext;
use sory_app_server_protocol::NetworkPolicyAmendment as V2NetworkPolicyAmendment;
use sory_app_server_protocol::NetworkPolicyRuleAction as V2NetworkPolicyRuleAction;
use sory_app_server_protocol::PermissionsRequestApprovalParams;
use sory_app_server_protocol::PermissionsRequestApprovalResponse;
use sory_app_server_protocol::RawResponseItemCompletedNotification;
use sory_app_server_protocol::RequestId;
use sory_app_server_protocol::ServerNotification;
use sory_app_server_protocol::ServerRequestPayload;
use sory_app_server_protocol::ThreadGoalUpdatedNotification;
use sory_app_server_protocol::ThreadItem;
use sory_app_server_protocol::ThreadRealtimeClosedNotification;
use sory_app_server_protocol::ThreadRealtimeErrorNotification;
use sory_app_server_protocol::ThreadRealtimeItemAddedNotification;
use sory_app_server_protocol::ThreadRealtimeOutputAudioDeltaNotification;
use sory_app_server_protocol::ThreadRealtimeSdpNotification;
use sory_app_server_protocol::ThreadRealtimeStartedNotification;
use sory_app_server_protocol::ThreadRealtimeTranscriptDeltaNotification;
use sory_app_server_protocol::ThreadRealtimeTranscriptDoneNotification;
use sory_app_server_protocol::ThreadRollbackResponse;
use sory_app_server_protocol::ThreadStatus;
use sory_app_server_protocol::ThreadTokenUsage;
use sory_app_server_protocol::ThreadTokenUsageUpdatedNotification;
use sory_app_server_protocol::ToolRequestUserInputOption;
use sory_app_server_protocol::ToolRequestUserInputParams;
use sory_app_server_protocol::ToolRequestUserInputQuestion;
use sory_app_server_protocol::ToolRequestUserInputResponse;
use sory_app_server_protocol::Turn;
use sory_app_server_protocol::TurnCompletedNotification;
use sory_app_server_protocol::TurnDiffUpdatedNotification;
...
use sory_app_server_protocol::TurnPlanStep;
use sory_app_server_protocol::TurnPlanUpdatedNotification;
use sory_app_server_protocol::TurnStartedNotification;
use sory_app_server_protocol::TurnStatus;
use sory_app_server_protocol::WarningNotification;
use sory_app_server_protocol::build_item_from_guardian_event;
use sory_app_server_protocol::guardian_auto_approval_review_notification;
use sory_app_server_protocol::item_event_to_server_notification;
use sory_core::SoryThread;
use sory_core::ThreadManager;
use sory_core::review_format::format_review_findings_block;
use sory_core::review_prompts;
use sory_protocol::ThreadId;
use sory_protocol::items::parse_hook_prompt_message;
use sory_protocol::models::AdditionalPermissionProfile as CoreAdditionalPermissionProfile;
use sory_protocol::plan_tool::UpdatePlanArgs;
use sory_protocol::protocol::SoryErrorInfo as CoresoryErrorInfo;
use sory_protocol::protocol::Event;
use sory_protocol::protocol::EventMsg;
use sory_protocol::protocol::ExecApprovalRequestEvent;
use sory_protocol::protocol::Op;
use sory_protocol::protocol::RealtimeEvent;
use sory_protocol::protocol::ReviewDecision;
use sory_protocol::protocol::ReviewOutputEvent;
...
use sory_protocol::protocol::TurnDiffEvent;
use sory_protocol::request_permissions::PermissionGrantScope as CorePermissionGrantScope;
use sory_protocol::request_permissions::RequestPermissionProfile as CoreRequestPermissionProfile;
use sory_protocol::request_permissions::RequestPermissionsResponse as CoreRequestPermissionsResponse;
use sory_protocol::request_user_input::RequestUserInputAnswer as CoreRequestUserInputAnswer;
use sory_protocol::request_user_input::RequestUserInputResponse as CoreRequestUserInputResponse;
use sory_sandboxing::policy_transforms::intersect_permission_profiles;
    ...
    match msg {
        ...
        EventMsg::McpStartupUpdate(update) => {
            let (status, error) = match update.status {
                sory_protocol::protocol::McpStartupStatus::Starting => {
                    (McpServerStartupState::Starting, None)
                }
                sory_protocol::protocol::McpStartupStatus::Ready => {
                    (McpServerStartupState::Ready, None)
                }
                sory_protocol::protocol::McpStartupStatus::Failed { error } => {
                    (McpServerStartupState::Failed, Some(error))
                }
                sory_protocol::protocol::McpStartupStatus::Cancelled => {
        ...
        EventMsg::GuardianAssessment(assessment) => {
            ...
            if assessment.status == sory_protocol::protocol::GuardianAssessmentStatus::InProgress
            ...
            let completion_status = match assessment.status {
                sory_protocol::protocol::GuardianAssessmentStatus::Denied
                | sory_protocol::protocol::GuardianAssessmentStatus::Aborted => {
                    Some(CommandExecutionStatus::Declined)
                }
                sory_protocol::protocol::GuardianAssessmentStatus::TimedOut => {
                    Some(CommandExecutionStatus::Failed)
                }
                sory_protocol::protocol::GuardianAssessmentStatus::InProgress
                | sory_protocol::protocol::GuardianAssessmentStatus::Approved => None,
            };
                ...
                Err(err) => {
                    ...
                    if let Err(err) = conversation
                        .submit(Op::ResolveElicitation {
                            ...
                            request_id: request.id,
                            decision: sory_protocol::approvals::ElicitationAction::Cancel,
                            content: None,
                            meta: None,
                        })
                        .await
        ...
        EventMsg::Error(ev) => {
            ...
            let sory_error_info = ev.sory_error_info.clone();
            ...
            if matches!(
                sory_error_info,
                Some(CoresoryErrorInfo::ThreadRollbackFailed)
            ) {
            ...
            let turn_error = TurnError {
                message: ev.message,
                sory_error_info: ev.sory_error_info.map(V2soryErrorInfo::from),
        ...
        EventMsg::ExecCommandBegin(exec_command_begin_event) => {
            if matches!(
                ...
                sory_protocol::protocol::ExecCommandSource::UnifiedExecInteraction
            ) {
...
async fn maybe_emit_raw_response_item_completed(
    conversation_id: ThreadId,
    turn_id: &str,
    item: sory_protocol::models::ResponseItem,
    outgoing: &ThreadScopedOutgoingMessageSender,
) {
...
pub(crate) async fn maybe_emit_hook_prompt_item_completed(
    ...
    let sory_protocol::models::ResponseItem::Message {
        role, content, id, ..
    } = item
    else {
        return;
    ...
    let notification = ItemCompletedNotification {
        ...
        item: ThreadItem::HookPrompt {
            ...
            fragments: hook_prompt
                .fragments
                .into_iter()
                .map(sory_app_server_protocol::HookPromptFragment::from)
                .collect(),
        },
    };
    outgoing
...
fn thread_rollback_response_from_stored_thread(
    stored_thread: sory_thread_store::StoredThread,
    session_id: String,
...
async fn on_mcp_server_elicitation_response(
    server_name: String,
    request_id: sory_protocol::mcp::RequestId,
    pending_request_id: RequestId,
    receiver: oneshot::Receiver<ClientRequestResult>,
    conversation: Arc<SoryThread>,
    thread_state: Arc<Mutex<ThreadState>>,
...
fn request_permissions_response_from_client_result(
    ...
    let response = serde_json::from_value::<PermissionsRequestApprovalResponse>(value)
        .unwrap_or_else(|err| {
            ...
            PermissionsRequestApprovalResponse {
                ...
                scope: sory_app_server_protocol::PermissionGrantScope::Turn,
    ...
    if strict_auto_review
        && matches!(
            response.scope,
            sory_app_server_protocol::PermissionGrantScope::Session
        )
    {
...
mod tests {
    ...
    use serde_json::json;
    use sory_app_server_protocol::AutoReviewDecisionSource;
    use sory_app_server_protocol::GuardianApprovalReviewStatus;
    use sory_app_server_protocol::JSONRPCErrorError;
    use sory_app_server_protocol::TurnPlanStepStatus;
    use sory_login::soryAuth;
    use sory_protocol::items::HookPromptFragment;
    use sory_protocol::items::build_hook_prompt_message;
    use sory_protocol::models::FileSystemPermissions as CoreFileSystemPermissions;
    use sory_protocol::models::NetworkPermissions as CoreNetworkPermissions;
    ...
    use sory_protocol::plan_tool::PlanItemArg;
    use sory_protocol::plan_tool::StepStatus;
    use sory_protocol::protocol::AgentMessageEvent;
    use sory_protocol::protocol::AskForApproval;
    use sory_protocol::protocol::CreditsSnapshot;
    use sory_protocol::protocol::EventMsg;
    use sory_protocol::protocol::GuardianAssessmentEvent;
    use sory_protocol::protocol::GuardianAssessmentStatus;
    ...
    use sory_thread_store::StoredThreadHistory;
    use sory_utils_absolute_path::AbsolutePathBuf;
    ...
    fn turn_aborted_event(turn_id: &str) -> TurnAbortedEvent {
        TurnAbortedEvent {
            ...
            reason: sory_protocol::protocol::TurnAbortReason::Interrupted,
            completed_at: Some(TEST_TURN_COMPLETED_AT),
            duration_ms: Some(TEST_TURN_DURATION_MS),
        }
    }
    ...
    fn guardian_command_assessment(
        ...
        let (risk_level, user_authorization, rationale) = match status {
            ...
            GuardianAssessmentStatus::Approved => (
                Some(sory_protocol::protocol::GuardianRiskLevel::Low),
                Some(sory_protocol::protocol::GuardianUserAuthorization::High),
                Some("looks safe".to_string()),
            ),
            GuardianAssessmentStatus::Denied => (
                Some(sory_protocol::protocol::GuardianRiskLevel::High),
                Some(sory_protocol::protocol::GuardianUserAuthorization::Low),
        ...
        GuardianAssessmentEvent {
            ...
            decision_source: if matches!(status, GuardianAssessmentStatus::InProgress) {
                ...
                Some(sory_protocol::protocol::GuardianAssessmentDecisionSource::Agent)
            },
    ...
    fn guardian_assessment_started_uses_event_turn_id_fallback() {
        ...
        let action = sory_protocol::protocol::GuardianAssessmentAction::Command {
            source: sory_protocol::protocol::GuardianCommandSource::Shell,
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: sory_protocol::protocol::GuardianAssessmentStatus::InProgress,
                risk_level: None,
    ...
    fn guardian_assessment_completed_emits_review_payload() {
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: sory_protocol::protocol::GuardianAssessmentStatus::Denied,
                risk_level: Some(sory_protocol::protocol::GuardianRiskLevel::High),
                user_authorization: Some(sory_protocol::protocol::GuardianUserAuthorization::Low),
                rationale: Some("too risky".to_string()),
                decision_source: Some(
                    sory_protocol::protocol::GuardianAssessmentDecisionSource::Agent,
                ),
                action: action.clone(),
            },
        );
        ...
        match notification {
            ServerNotification::ItemGuardianApprovalReviewCompleted(payload) => {
                ...
                assert_eq!(
                    ...
                    Some(sory_app_server_protocol::GuardianRiskLevel::High)
                );
                assert_eq!(
                    payload.review.user_authorization,
                    Some(sory_app_server_protocol::GuardianUserAuthorization::Low)
                );
    ...
    fn guardian_assessment_aborted_emits_completed_review_payload() {
        let conversation_id = ThreadId::new();
        let action = sory_protocol::protocol::GuardianAssessmentAction::NetworkAccess {
            target: "api.openai.com:443".to_string(),
            host: "api.openai.com".to_string(),
            protocol: sory_protocol::protocol::NetworkApprovalProtocol::Https,
            port: 443,
        };
        let notification = guardian_auto_approval_review_notification(
            &conversation_id,
            ...
            &GuardianAssessmentEvent {
                ...
                started_at_ms: 1_000,
                completed_at_ms: Some(1_042),
                status: sory_protocol::protocol::GuardianAssessmentStatus::Aborted,
                risk_level: None,
                user_authorization: None,
                rationale: None,
                decision_source: Some(
    ...
    async fn command_execution_started_helper_emits_once() -> Result<()> {
        ...
        let outgoing = Arc::new(OutgoingMessageSender::new(
            tx,
            sory_analytics::AnalyticsEventsClient::disabled(),
        ));
    ...
    async fn guardian_command_execution_notifications_wrap_review_lifecycle() -> Result<()> {
        ...
        let config = load_default_config_for_test(&sory_home).await;
        let thread_manager = Arc::new(
            sory_core::test_support::thread_manager_with_models_provider_and_home(
                soryAuth::create_dummy_chatgpt_auth_for_testing(),
                config.model_provider.clone(),
                config.sory_home.to_path_buf(),
                Arc::new(sory_exec_server::EnvironmentManager::default_for_tests()),
            ),
        );
        let sory_core::NewThread {
    ...
    async fn test_handle_error_records_message() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                sory_error_info: Some(V2soryErrorInfo::InternalServerError),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn turn_started_omits_active_snapshot_items() -> Result<()> {
        ...
        let thread_state = new_thread_state();
        {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::TurnStarted(sory_protocol::protocol::TurnStartedEvent {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::UserMessage(sory_protocol::protocol::UserMessageEvent {
        ...
        apply_bespoke_event_handling(
            Event {
                id: "turn-1".to_string(),
                msg: EventMsg::TurnStarted(sory_protocol::protocol::TurnStartedEvent {
                    turn_id: "turn-1".to_string(),
                    started_at: Some(42),
                    model_context_window: None,
                    collaboration_mode_kind: Default::default(),
    ...
    async fn test_handle_turn_complete_emits_failed_with_error() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                sory_error_info: Some(V2soryErrorInfo::Other),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn test_handle_token_count_event_emits_usage_and_rate_limits() -> Result<()> {
        ...
        match second {
            OutgoingMessage::AppServerNotification(
                ...
                assert_eq!(payload.rate_limits.limit_id.as_deref(), Some("sory"));
    ...
    async fn test_handle_turn_complete_emits_error_multiple_turns() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                sory_error_info: Some(V2soryErrorInfo::BadRequest),
                additional_details: None,
            },
            &thread_state,
        )
            ...
            OutgoingMessage::AppServerNotification(ServerNotification::ItemCompleted(
                ...
                assert_eq!(
                    ...
                    ThreadItem::HookPrompt {
                        ...
                        fragments: vec![
                            sory_app_server_protocol::HookPromptFragment {
