...
pub(crate) struct PendingThreadResumeRequest {
    ...
    pub(crate) thread_summary: sory_app_server_protocol::Thread,
...
pub(crate) struct ThreadState {
    ...
    listener_thread: Option<Weak<SoryThread>>,
    watch_registration: WatchRegistration,
}

impl ThreadState {
    pub(crate) fn listener_matches(&self, conversation: &Arc<SoryThread>) -> bool {
