...
mod tests {
    ...
    use sory_config::ThreadConfigContext;
    use sory_config::ThreadConfigLoadError;
    use sory_config::ThreadConfigLoadErrorCode;
    ...
    async fn refresh_test_state() -> anyhow::Result<(
        ...
        let auth_manager = AuthManager::from_auth_for_testing(soryAuth::from_api_key("dummy"));
