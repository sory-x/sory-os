    ...
    route_outgoing_envelope(
        ...
        OutgoingEnvelope::ToConnection {
            ...
            message: OutgoingMessage::Request(ServerRequest::CommandExecutionRequestApproval {
                ...
                params: sory_app_server_protocol::CommandExecutionRequestApprovalParams {
                    ...
                    additional_permissions: Some(
                        sory_app_server_protocol::AdditionalPermissionProfile {
                            network: None,
                            file_system: Some(
                                sory_app_server_protocol::AdditionalFileSystemPermissions {
