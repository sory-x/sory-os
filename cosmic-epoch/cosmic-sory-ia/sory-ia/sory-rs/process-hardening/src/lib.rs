...
pub(crate) fn pre_main_hardening_linux() {
    ...
    // Official sory releases are MUSL-linked, which means that variables such
...
pub(crate) fn pre_main_hardening_macos() {
    ...
    // sory or inherited child processes do not get sprayed into the TUI:
    // https://github.com/openai/sory/issues/11555
