...
use crate::SORY_API_KEY_ENV_VAR;
...
impl AuthEnvTelemetry {
    pub fn to_otel_metadata(&self) -> AuthEnvTelemetryMetadata {
        AuthEnvTelemetryMetadata {
            ...
            sory_api_key_env_present: self.sory_api_key_env_present,
            sory_api_key_env_enabled: self.sory_api_key_env_enabled,
...
pub fn collect_auth_env_telemetry(
    ...
    sory_api_key_env_enabled: bool,
) -> AuthEnvTelemetry {
    AuthEnvTelemetry {
        openai_api_key_env_present: env_var_present(OPENAI_API_KEY_ENV_VAR),
        sory_api_key_env_present: env_var_present(SORY_API_KEY_ENV_VAR),
        sory_api_key_env_enabled,
...
mod tests {
    ...
    fn collect_auth_env_telemetry_buckets_provider_env_key_name() {
        ...
        let telemetry =
            collect_auth_env_telemetry(&provider, /*sory_api_key_env_enabled*/ false);
