...
use sory_agent_identity::register_agent_task;
...
const SORY_AGENT_IDENTITY_AUTHAPI_BASE_URL_ENV_VAR: &str = "sory_AGENT_IDENTITY_AUTHAPI_BASE_URL";
...
fn agent_identity_authapi_base_url() -> String {
    env::var(SORY_AGENT_IDENTITY_AUTHAPI_BASE_URL_ENV_VAR)
        .ok()
...
mod tests {
    ...
    fn agent_identity_authapi_base_url_prefers_env_value() {
        let _guard = EnvVarGuard::set(
            SORY_AGENT_IDENTITY_AUTHAPI_BASE_URL_ENV_VAR,
    ...
    fn agent_identity_authapi_base_url_uses_prod_authapi_by_default() {
        let _guard = EnvVarGuard::remove(SORY_AGENT_IDENTITY_AUTHAPI_BASE_URL_ENV_VAR);
        assert_eq!(
            agent_identity_authapi_base_url(),
