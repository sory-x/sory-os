        ...
        match event.payload {
            ...
            RawTraceEventPayload::CodeCellStarted {
                ...
                self.start_or_queue_code_cell(PendingCodeCellStart {
                    ...
                    thread_id,
                    sory_turn_id: event.sory_turn_id,
            ...
            RawTraceEventPayload::CompactionInstalled {
                ...
                let Some(sory_turn_id) = event.sory_turn_id else {
                    bail!(
                        "compaction installed event {compaction_id} did not include a sory turn id"
                    );
                };
