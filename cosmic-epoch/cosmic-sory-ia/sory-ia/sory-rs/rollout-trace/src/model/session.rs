...
/// One sory thread/session participating in the rollout.
///
...
/// Provenance for a traced sory thread.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
...
/// One activation of the sory runtime for one thread.
///
/// A sory turn groups protocol/runtime work for one thread activation.
