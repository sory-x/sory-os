...
/// sory conversation/session UUID.
...
/// Process/session ID returned by sory's terminal runtime.
...
/// Canonical reduced graph for one sory rollout.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct RolloutTrace {
    pub schema_version: u32,
    /// Unique identity for this trace capture.
    ///
    /// `rollout_id` names the sory rollout/session being observed. `trace_id`
    ...
    pub sory_turns: BTreeMap<soryTurnId, soryTurn>,
