...
/// Runtime operation requested by the model, a JS code cell, or sory itself.
///
...
pub struct ToolCall {
    ...
    pub started_by_sory_turn_id: Option<soryTurnId>,
    pub execution: ExecutionWindow,
    ...
    /// Original invocation at the sory tool boundary.
    ///
    ...
    /// they describe how sory executed the request, not what the caller sent.
