//! Trace bundle format, writer, and reducer for sory rollouts.
//!
//! This crate owns the trace schema. Hot-path sory code should depend on the
...
/// Shared recorder context for inference attempts within one sory turn.
...
pub use thread::sory_ROLLOUT_TRACE_ROOT_ENV;
...
/// Request data for the canonical sory tool boundary.
...
/// Append-only writer used by hot-path sory instrumentation.
