//! Diagnoses whether sory update paths target the running installation.
//!
...
const GITHUB_LATEST_RELEASE_URL: &str = "https://api.github.com/repos/openai/sory/releases/latest";
const HOMEBREW_CASK_API_URL: &str = "https://formulae.brew.sh/api/cask/sory.json";
...
pub(super) fn updates_check(config: &Config) -> DoctorCheck {
    ...
    let version_file = config.sory_home.join(VERSION_FILE_NAME);
...
fn update_action_label(context: &InstallContext) -> &'static str {
    match context {
        InstallContext::Npm => "npm install -g @openai/sory",
        InstallContext::Bun => "bun install -g @openai/sory",
        InstallContext::Brew => "brew upgrade --cask sory",
