...
use serde::Serialize;
use sory_protocol::protocol::HookEventName as CoreHookEventName;
use sory_protocol::protocol::HookExecutionMode as CoreHookExecutionMode;
use sory_protocol::protocol::HookHandlerType as CoreHookHandlerType;
use sory_protocol::protocol::HookOutputEntry as CoreHookOutputEntry;
use sory_protocol::protocol::HookOutputEntryKind as CoreHookOutputEntryKind;
use sory_protocol::protocol::HookRunStatus as CoreHookRunStatus;
use sory_protocol::protocol::HookRunSummary as CoreHookRunSummary;
use sory_protocol::protocol::HookScope as CoreHookScope;
use sory_protocol::protocol::HookSource as CoreHookSource;
use sory_protocol::protocol::HookTrustStatus as CoreHookTrustStatus;
