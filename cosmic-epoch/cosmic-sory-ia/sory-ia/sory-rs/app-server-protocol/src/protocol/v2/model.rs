...
use sory_protocol::openai_models::ModelAvailabilityNux as CoreModelAvailabilityNux;
use sory_protocol::openai_models::ReasoningEffort;
use sory_protocol::openai_models::default_input_modalities;
use sory_protocol::protocol::ModelRerouteReason as CoreModelRerouteReason;
use sory_protocol::protocol::ModelVerification as CoreModelVerification;
use ts_rs::TS;
