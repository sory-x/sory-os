...
use sory_protocol::approvals::GuardianAssessmentAction as CoreGuardianAssessmentAction;
use sory_protocol::approvals::GuardianAssessmentDecisionSource as CoreGuardianAssessmentDecisionSource;
use sory_protocol::approvals::GuardianCommandSource as CoreGuardianCommandSource;
use sory_protocol::items::AgentMessageContent as CoreAgentMessageContent;
...
use sory_protocol::parse_command::ParsedCommand as CoreParsedCommand;
use sory_protocol::protocol::AgentStatus as CoreAgentStatus;
use sory_protocol::protocol::ExecCommandSource as CoreExecCommandSource;
use sory_protocol::protocol::ExecCommandStatus as CoreExecCommandStatus;
use sory_protocol::protocol::GuardianRiskLevel as CoreGuardianRiskLevel;
use sory_protocol::protocol::GuardianUserAuthorization as CoreGuardianUserAuthorization;
use sory_protocol::protocol::PatchApplyStatus as CorePatchApplyStatus;
use sory_protocol::protocol::ReviewDecision as CoreReviewDecision;
...
impl From<sory_protocol::models::WebSearchAction> for WebSearchAction {
    fn from(value: sory_protocol::models::WebSearchAction) -> Self {
        match value {
            sory_protocol::models::WebSearchAction::Search { query, queries } => {
                WebSearchAction::Search { query, queries }
            }
            sory_protocol::models::WebSearchAction::OpenPage { url } => {
                WebSearchAction::OpenPage { url }
            }
            sory_protocol::models::WebSearchAction::FindInPage { url, pattern } => {
                WebSearchAction::FindInPage { url, pattern }
            }
            sory_protocol::models::WebSearchAction::Other => WebSearchAction::Other,
        }
    }
}
...
impl From<sory_protocol::items::HookPromptFragment> for HookPromptFragment {
    fn from(value: sory_protocol::items::HookPromptFragment) -> Self {
        Self {
            text: value.text,
...
impl From<DynamicToolCallOutputContentItem>
    for sory_protocol::dynamic_tools::DynamicToolCallOutputContentItem
{
