...
use sory_protocol::protocol::SubAgentSource as CoreSubAgentSource;
use sory_protocol::protocol::ThreadSource as CoreThreadSource;
...
pub struct Thread {
    ...
    /// Origin of the thread (CLI, VSCode, sory exec, sory app-server, etc.).
