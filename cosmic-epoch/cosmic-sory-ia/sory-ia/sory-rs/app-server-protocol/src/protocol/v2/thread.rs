...
use sory_protocol::protocol::ThreadGoalStatus as CoreThreadGoalStatus;
use sory_protocol::protocol::TokenUsage as CoreTokenUsage;
use sory_protocol::protocol::TokenUsageInfo as CoreTokenUsageInfo;
...
pub struct ThreadStartParams {
    ...
    /// This is for internal use only (e.g. sory Cloud).
...
pub struct ThreadResumeParams {
    ...
    /// [UNSTABLE] FOR sory CLOUD - DO NOT USE.
...
impl From<sory_protocol::protocol::ThreadGoal> for ThreadGoal {
    fn from(value: sory_protocol::protocol::ThreadGoal) -> Self {
        Self {
...
impl ThreadMemoryMode {
    ...
    pub fn to_core(self) -> sory_protocol::protocol::ThreadMemoryMode {
        match self {
            Self::Enabled => sory_protocol::protocol::ThreadMemoryMode::Enabled,
            Self::Disabled => sory_protocol::protocol::ThreadMemoryMode::Disabled,
        }
    }
}
...
pub struct ThreadApproveGuardianDeniedActionParams {
    pub thread_id: String,
    /// Serialized `sory_protocol::protocol::GuardianAssessmentEvent`.
    pub event: JsonValue,
}
