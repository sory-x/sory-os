...
use serde::Serialize;
use sory_protocol::protocol::SkillDependencies as CoreSkillDependencies;
use sory_protocol::protocol::SkillInterface as CoreSkillInterface;
use sory_protocol::protocol::SkillMetadata as CoreSkillMetadata;
use sory_protocol::protocol::SkillScope as CoreSkillScope;
use sory_protocol::protocol::SkillToolDependency as CoreSkillToolDependency;
...
pub enum PluginAvailability {
    ...
    /// sory app-server exposes `"AVAILABLE"` in its API; the alias keeps
