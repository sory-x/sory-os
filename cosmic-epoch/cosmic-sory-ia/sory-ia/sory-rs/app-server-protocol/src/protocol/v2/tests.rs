...
use serde_json::json;
use sory_protocol::approvals::ElicitationRequest as CoreElicitationRequest;
use sory_protocol::items::AgentMessageContent;
use sory_protocol::items::AgentMessageItem;
use sory_protocol::items::FileChangeItem;
use sory_protocol::items::ImageViewItem;
use sory_protocol::items::McpToolCallItem;
use sory_protocol::items::McpToolCallStatus as CoreMcpToolCallStatus;
...
use sory_protocol::memory_citation::MemoryCitation as CoreMemoryCitation;
use sory_protocol::memory_citation::MemoryCitationEntry as CoreMemoryCitationEntry;
...
use sory_protocol::permissions::FileSystemAccessMode as CoreFileSystemAccessMode;
use sory_protocol::permissions::FileSystemPath as CoreFileSystemPath;
use sory_protocol::permissions::FileSystemSandboxEntry as CoreFileSystemSandboxEntry;
use sory_protocol::permissions::FileSystemSpecialPath as CoreFileSystemSpecialPath;
use sory_protocol::protocol::AgentStatus as CoreAgentStatus;
use sory_protocol::protocol::AskForApproval as CoreAskForApproval;
use sory_protocol::protocol::GranularApprovalConfig as CoreGranularApprovalConfig;
use sory_protocol::protocol::NetworkAccess as CoreNetworkAccess;
use sory_protocol::request_permissions::RequestPermissionProfile as CoreRequestPermissionProfile;
use sory_protocol::user_input::UserInput as CoreUserInput;
...
fn core_turn_item_into_thread_item_converts_supported_variants() {
    let user_item = TurnItem::UserMessage(UserMessageItem {
        ...
        content: vec![
            ...
            CoreUserInput::Skill {
                ...
                path: PathBuf::from("/repo/.sory/skills/skill-creator/SKILL.md"),
            },
    ...
    let file_change_item = TurnItem::FileChange(FileChangeItem {
        ...
        .into_iter()
        .collect(),
        status: Some(sory_protocol::protocol::PatchApplyStatus::Completed),
        auto_approved: None,
...
fn plugin_share_params_and_response_serialization_use_camel_case_fields() {
    ...
    assert_eq!(
        serde_json::to_value(PluginShareCheckoutResponse {
            remote_plugin_id: "plugins~Plugin_00000000000000000000000000000000".to_string(),
            plugin_id: "gmail@sory-curated".to_string(),
            plugin_name: "gmail".to_string(),
            plugin_path,
            marketplace_name: "sory-curated".to_string(),
            marketplace_path,
        ...
        json!({
            "remotePluginId": "plugins~Plugin_00000000000000000000000000000000",
            "pluginId": "gmail@sory-curated",
            "pluginName": "gmail",
            "pluginPath": plugin_path_json,
            "marketplaceName": "sory-curated",
            "marketplacePath": marketplace_path_json,
            "remoteVersion": "1.2.3",
        }),
    );
...
#[test]
fn sory_error_info_serializes_http_status_code_in_camel_case() {
    let value = SoryErrorInfo::ResponseTooManyFailedAttempts {
...
#[test]
fn sory_error_info_serializes_cyber_policy_in_camel_case() {
    assert_eq!(
        serde_json::to_value(SoryErrorInfo::CyberPolicy).unwrap(),
        json!("cyberPolicy")
    );
}

#[test]
fn sory_error_info_serializes_active_turn_not_steerable_turn_kind_in_camel_case() {
    let value = SoryErrorInfo::ActiveTurnNotSteerable {
