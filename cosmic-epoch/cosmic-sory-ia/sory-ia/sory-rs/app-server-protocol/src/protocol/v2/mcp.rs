...
use sory_protocol::items::McpToolCallError as CoreMcpToolCallError;
use sory_protocol::mcp::CallToolResult as CoreMcpCallToolResult;
use sory_protocol::mcp::Resource as McpResource;
pub use sory_protocol::mcp::ResourceContent as McpResourceContent;
use sory_protocol::mcp::ResourceTemplate as McpResourceTemplate;
use sory_protocol::mcp::Tool as McpTool;
use std::collections::BTreeMap;
use ts_rs::TS;

v2_enum_from_core!(
    pub enum McpAuthStatus from sory_protocol::protocol::McpAuthStatus {
        Unsupported,
        NotLoggedIn,
        BearerToken,
        OAuth
...
impl McpServerElicitationAction {
    pub fn to_core(self) -> sory_protocol::approvals::ElicitationAction {
        match self {
            Self::Accept => sory_protocol::approvals::ElicitationAction::Accept,
            Self::Decline => sory_protocol::approvals::ElicitationAction::Decline,
            Self::Cancel => sory_protocol::approvals::ElicitationAction::Cancel,
        }
    }
}
...
pub struct McpServerElicitationRequestParams {
    pub thread_id: String,
    /// Active sory turn when this elicitation was observed, if app-server could correlate one.
    ///
