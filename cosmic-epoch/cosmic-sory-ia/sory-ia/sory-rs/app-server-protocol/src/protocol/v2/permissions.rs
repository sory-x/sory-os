...
use sory_protocol::approvals::ExecPolicyAmendment as CoreExecPolicyAmendment;
use sory_protocol::approvals::NetworkApprovalContext as CoreNetworkApprovalContext;
use sory_protocol::approvals::NetworkApprovalProtocol as CoreNetworkApprovalProtocol;
use sory_protocol::approvals::NetworkPolicyAmendment as CoreNetworkPolicyAmendment;
use sory_protocol::approvals::NetworkPolicyRuleAction as CoreNetworkPolicyRuleAction;
use sory_protocol::models::ActivePermissionProfile as CoreActivePermissionProfile;
...
impl SandboxPolicy {
    pub fn to_core(&self) -> sory_protocol::protocol::SandboxPolicy {
        match self {
...
impl From<sory_protocol::protocol::SandboxPolicy> for SandboxPolicy {
    fn from(value: sory_protocol::protocol::SandboxPolicy) -> Self {
        match value {
            sory_protocol::protocol::SandboxPolicy::DangerFullAccess => {
                SandboxPolicy::DangerFullAccess
            }
            sory_protocol::protocol::SandboxPolicy::ReadOnly { network_access } => {
                SandboxPolicy::ReadOnly { network_access }
            }
            sory_protocol::protocol::SandboxPolicy::ExternalSandbox { network_access } => {
