...
async fn copy_paste_local_image_persists_rollout_request_shape() -> anyhow::Result<()> {
    ...
    let rollout_path = sory.rollout_path().expect("rollout path");
    ...
    let expected = ResponseItem::Message {
        ...
        content: vec![
            ContentItem::InputText {
                text: sory_protocol::models::local_image_open_tag_text(/*label_number*/ 1),
            },
            ...
            ContentItem::InputText {
                text: sory_protocol::models::image_close_tag_text(),
            },
            ContentItem::InputText {
                text: "pasted image".to_string(),
            },
...
async fn drag_drop_image_persists_rollout_request_shape() -> anyhow::Result<()> {
    ...
    let expected = ResponseItem::Message {
        ...
        content: vec![
            ContentItem::InputText {
                text: sory_protocol::models::image_open_tag_text(),
            },
            ContentItem::InputImage {
                image_url,
                detail: Some(DEFAULT_IMAGE_DETAIL),
