...
pub(crate) struct ConfigLockReplayOptions {
    pub allow_sory_version_mismatch: bool,
}
...
pub(crate) fn validate_config_lock_replay(
    ...
    if !options.allow_sory_version_mismatch
        && expected_lock.sory_version != actual_lock.sory_version
    {
        return Err(config_lock_error(format!(
            "config lock sory version mismatch: lock was generated by {}, current version is {}; set debug.config_lockfile.allow_sory_version_mismatch=true to ignore this",
            expected_lock.sory_version, actual_lock.sory_version
        )));
    }
