...
use sory_core_plugins::OPENAI_BUNDLED_MARKETPLACE_NAME;
use sory_core_plugins::OPENAI_CURATED_MARKETPLACE_NAME;
use sory_core_plugins::PluginsManager;
use sory_core_plugins::TOOL_SUGGEST_DISCOVERABLE_PLUGIN_ALLOWLIST;
...
pub(crate) async fn list_tool_suggest_discoverable_plugins(
    ...
    let plugins_manager = PluginsManager::new(config.sory_home.to_path_buf());
