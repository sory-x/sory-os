...
use sory_models_manager::collaboration_mode_presets;
...
pub fn auth_manager_from_auth(auth: soryAuth) -> Arc<AuthManager> {
    AuthManager::from_auth_for_testing(auth)
}

pub fn auth_manager_from_auth_with_home(auth: soryAuth, sory_home: PathBuf) -> Arc<AuthManager> {
    AuthManager::from_auth_for_testing_with_home(auth, sory_home)
}
...
) -> sory_protocol::error::Result<crate::NewThread> {
    thread_manager
...
pub fn models_manager_with_provider(
    ...
    provider.models_manager(sory_home, /*config_model_catalog*/ None)
}
