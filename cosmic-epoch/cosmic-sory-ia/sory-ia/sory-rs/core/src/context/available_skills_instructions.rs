use sory_core_skills::AvailableSkills;
use sory_core_skills::render_available_skills_body;
use sory_protocol::protocol::SKILLS_INSTRUCTIONS_CLOSE_TAG;
use sory_protocol::protocol::SKILLS_INSTRUCTIONS_OPEN_TAG;
