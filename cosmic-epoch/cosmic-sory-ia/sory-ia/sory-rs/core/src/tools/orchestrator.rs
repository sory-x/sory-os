...
use sory_otel::ToolDecisionSource;
...
impl ToolOrchestrator {
        ...
        T: ToolRuntime<Rq, Out>,
    {
        ...
        let attempt_with_network_approval = SandboxAttempt {
            ...
            sory_linux_sandbox_exe: attempt.sory_linux_sandbox_exe,
        ...
        T: ToolRuntime<Rq, Out>,
    {
        ...
        let initial_attempt = SandboxAttempt {
            ...
            sandbox_cwd,
            sory_linux_sandbox_exe: turn_ctx.sory_linux_sandbox_exe.as_ref(),
            use_legacy_landlock,
    ...
    async fn request_approval<Rq, Out, T>(
        ...
        otel: &sory_otel::SessionTelemetry,
