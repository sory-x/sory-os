...
use sory_protocol::approvals::NetworkApprovalContext;
...
use sory_sandboxing::SandboxTransformError;
...
pub(crate) enum ExecApprovalRequirement {
    ...
    Skip {
        ...
        /// Only applies if the command fails to run in sandbox and sory prompts the user to run outside the sandbox.
...
pub(crate) struct SandboxAttempt<'a> {
    ...
    pub permissions: &'a sory_protocol::models::PermissionProfile,
    pub enforce_managed_network: bool,
    pub(crate) manager: &'a SandboxManager,
    pub(crate) sandbox_cwd: &'a AbsolutePathBuf,
    pub sory_linux_sandbox_exe: Option<&'a std::path::PathBuf>,
        ...
        self.manager
            ...
            .map(|request| {
                let windows_sandbox_policy_cwd =
                    sory_utils_absolute_path::AbsolutePathBuf::try_from(
