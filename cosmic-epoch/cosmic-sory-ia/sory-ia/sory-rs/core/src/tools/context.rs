...
use sory_protocol::models::function_call_output_content_items_to_text;
use sory_tools::LoadableToolSpec;
use sory_tools::ToolName;
use sory_utils_output_truncation::TruncationPolicy;
use sory_utils_output_truncation::formatted_truncate_text;
use sory_utils_string::take_bytes_at_char_boundary;
use serde::Serialize;
...
pub enum ToolCallSource {
    ...
    CodeMode {
        ...
        /// debugging the JS/runtime bridge, but it is not the sory tool call id
