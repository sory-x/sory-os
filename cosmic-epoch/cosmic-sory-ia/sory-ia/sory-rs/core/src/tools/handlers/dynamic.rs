...
use sory_protocol::dynamic_tools::DynamicToolCallRequest;
...
use sory_tools::dynamic_tool_to_responses_api_tool;
    ...
    fn search_info(&self) -> Option<ToolSearchInfo> {
        ToolSearchInfo::from_spec(
            ...
            Some(ToolSearchSourceInfo {
                ...
                description: Some("Tools provided by the current sory thread.".to_string()),
            }),
        )
    }
}
