...
use sory_tools::LoadableToolSpec;
use sory_tools::TOOL_SEARCH_DEFAULT_LIMIT;
use sory_tools::TOOL_SEARCH_TOOL_NAME;
use sory_tools::ToolName;
use sory_tools::ToolSearchSourceInfo;
use sory_tools::ToolSpec;
use sory_tools::coalesce_loadable_tool_specs;
    ...
    fn mixed_search_results_coalesce_mcp_namespaces() {
        ...
        assert_eq!(
            ...
            vec![
                LoadableToolSpec::Namespace(ResponsesApiNamespace {
                    ...
                    tools: vec![
                        ResponsesApiNamespaceTool::Function(ResponsesApiTool {
                            ...
                            parameters: sory_tools::JsonSchema::object(
                                Default::default(),
                                /*required*/ None,
                                Some(false.into()),
                            ),
                ...
                LoadableToolSpec::Namespace(ResponsesApiNamespace {
                    name: "sory_app".to_string(),
                    description: "Tools in the sory_app namespace.".to_string(),
                    tools: vec![ResponsesApiNamespaceTool::Function(ResponsesApiTool {
                        ...
                        parameters: sory_tools::JsonSchema::object(
                            std::collections::BTreeMap::from([(
                                "mode".to_string(),
                                sory_tools::JsonSchema::string(/*description*/ None),
                            )]),
