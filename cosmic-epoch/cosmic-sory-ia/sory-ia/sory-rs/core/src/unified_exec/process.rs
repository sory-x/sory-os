...
use sory_exec_server::ReadResponse as ExecReadResponse;
use sory_exec_server::StartedExecProcess;
use sory_exec_server::WriteStatus;
use sory_protocol::exec_output::ExecToolCallOutput;
use sory_protocol::exec_output::StreamOutput;
use sory_protocol::protocol::TruncationPolicy;
...
impl UnifiedExecProcess {
    ...
    pub(super) async fn from_spawned(
        ...
        let output_rx = sory_utils_pty::combine_output_receivers(stdout_rx, stderr_rx);
