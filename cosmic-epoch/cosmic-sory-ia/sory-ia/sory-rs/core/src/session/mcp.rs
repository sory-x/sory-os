use super::*;
use sory_mcp::ElicitationReviewRequest;
use sory_mcp::ElicitationReviewer;
use sory_mcp::ElicitationReviewerHandle;
use sory_protocol::config_types::ApprovalsReviewer;
use sory_protocol::mcp_approval_meta::APPROVAL_KIND_KEY as MCP_ELICITATION_APPROVAL_KIND_KEY;
use sory_protocol::mcp_approval_meta::APPROVAL_KIND_MCP_TOOL_CALL as MCP_ELICITATION_APPROVAL_KIND_MCP_TOOL_CALL;
use sory_protocol::mcp_approval_meta::APPROVALS_REVIEWER_KEY as MCP_ELICITATION_APPROVALS_REVIEWER_KEY;
use sory_protocol::mcp_approval_meta::CONNECTOR_DESCRIPTION_KEY as MCP_ELICITATION_CONNECTOR_DESCRIPTION_KEY;
use sory_protocol::mcp_approval_meta::CONNECTOR_ID_KEY as MCP_ELICITATION_CONNECTOR_ID_KEY;
use sory_protocol::mcp_approval_meta::CONNECTOR_NAME_KEY as MCP_ELICITATION_CONNECTOR_NAME_KEY;
use sory_protocol::mcp_approval_meta::REQUEST_TYPE_APPROVAL_REQUEST as MCP_ELICITATION_REQUEST_TYPE_APPROVAL_REQUEST;
use sory_protocol::mcp_approval_meta::REQUEST_TYPE_KEY as MCP_ELICITATION_REQUEST_TYPE_KEY;
use sory_protocol::mcp_approval_meta::TOOL_DESCRIPTION_KEY as MCP_ELICITATION_TOOL_DESCRIPTION_KEY;
use sory_protocol::mcp_approval_meta::TOOL_NAME_KEY as MCP_ELICITATION_TOOL_NAME_KEY;
use sory_protocol::mcp_approval_meta::TOOL_PARAMS_KEY as MCP_ELICITATION_TOOL_PARAMS_KEY;
use sory_protocol::mcp_approval_meta::TOOL_TITLE_KEY as MCP_ELICITATION_TOOL_TITLE_KEY;
...
impl Session {
    ...
    pub async fn request_mcp_server_elicitation(
            ...
            .elicitations_auto_deny()
        {
            return Some(ElicitationResponse {
                action: sory_rmcp_client::ElicitationAction::Accept,
        ...
        let request = match params.request {
            McpServerElicitationRequest::Form {
                ...
                sory_protocol::approvals::ElicitationRequest::Form {
                    meta,
                    message,
                    requested_schema,
                }
        ...
        let id = match request_id {
            rmcp::model::NumberOrString::String(value) => {
                sory_protocol::mcp::RequestId::String(value.to_string())
            }
            rmcp::model::NumberOrString::Number(value) => {
                sory_protocol::mcp::RequestId::Integer(value)
            }
        };
    ...
    async fn refresh_mcp_servers_inner(
        ...
        let host_owned_sory_apps_enabled =
            host_owned_sory_apps_enabled(&mcp_config, auth.as_ref());
        let auth_statuses =
