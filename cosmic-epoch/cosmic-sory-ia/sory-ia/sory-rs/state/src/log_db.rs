...
//!
//! # async fn example(state_db: std::sync::Arc<sory_state::StateRuntime>) {
...
mod tests {
    ...
    fn temp_sory_home() -> std::path::PathBuf {
        std::env::temp_dir().join(format!("sory-state-log-db-{}", Uuid::new_v4()))
    }
