...
use sory_utils_pty::ExecCommandSession;
...
impl LocalProcess {
    ...
    async fn start_process(
        ...
        let spawned_result = if params.tty {
            ...
            sory_utils_pty::spawn_pipe_process(
                program,
                args,
                params.cwd.as_path(),
                &env,
            ...
            sory_utils_pty::spawn_pipe_process_no_stdin(
                program,
                args,
                params.cwd.as_path(),
                &env,
...
mod tests {
    ...
    fn dummy_session() -> ExecCommandSession {
        ...
        sory_utils_pty::spawn_from_driver(ProcessDriver {
            writer_tx,
            stdout_rx,
