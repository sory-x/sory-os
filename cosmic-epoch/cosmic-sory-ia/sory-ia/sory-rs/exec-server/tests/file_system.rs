...
use sory_exec_server::LocalFileSystem;
use sory_exec_server::ReadDirectoryEntry;
...
use common::exec_server::TestsoryHelperPaths;
use common::exec_server::exec_server;
#[cfg(target_os = "linux")]
use common::exec_server::exec_server_with_env;
use common::exec_server::test_sory_helper_paths;

struct FileSystemContext {
    file_system: Arc<dyn ExecutorFileSystem>,
    _helper_paths: Option<TestsoryHelperPaths>,
...
async fn create_file_system_context(use_remote: bool) -> Result<FileSystemContext> {
    if use_remote {
        ...
        let helper_paths = test_sory_helper_paths()?;
        let runtime_paths = ExecServerRuntimePaths::new(
            helper_paths.sory_exe.clone(),
            helper_paths.sory_linux_sandbox_exe.clone(),
        )?;
        Ok(FileSystemContext {
