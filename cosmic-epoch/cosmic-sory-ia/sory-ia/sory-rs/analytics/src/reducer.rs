...
use crate::events::soryCollabAgentToolCallEventParams;
use crate::events::soryCollabAgentToolCallEventRequest;
...
use crate::events::soryDynamicToolCallEventParams;
use crate::events::soryDynamicToolCallEventRequest;
use crate::events::soryFileChangeEventParams;
use crate::events::soryFileChangeEventRequest;
use crate::events::soryHookRunEventRequest;
use crate::events::soryImageGenerationEventParams;
use crate::events::soryImageGenerationEventRequest;
use crate::events::soryMcpToolCallEventParams;
use crate::events::soryMcpToolCallEventRequest;
...
use crate::events::soryTurnEventParams;
use crate::events::soryTurnEventRequest;
use crate::events::soryTurnSteerEventParams;
use crate::events::soryTurnSteerEventRequest;
use crate::events::soryWebSearchEventParams;
use crate::events::soryWebSearchEventRequest;
...
use crate::events::sory_compaction_event_params;
...
use sory_app_server_protocol::ClientResponse;
use sory_app_server_protocol::SoryErrorInfo;
use sory_app_server_protocol::CollabAgentStatus;
...
use sory_app_server_protocol::DynamicToolCallOutputContentItem;
...
use sory_app_server_protocol::NetworkPolicyRuleAction;
use sory_app_server_protocol::PatchApplyStatus;
use sory_app_server_protocol::PatchChangeKind;
...
use sory_app_server_protocol::WebSearchAction;
use sory_git_utils::collect_git_info;
...
impl<'a> AnalyticsDropSite<'a> {
    ...
    fn compaction(input: &'a soryCompactionEvent) -> Self {
        Self {
    ...
    fn tool_item(
        notification: &'a sory_app_server_protocol::ItemCompletedNotification,
        item_id: &'a str,
    ) -> Self {
        Self {
...
struct CompletedTurnState {
    ...
    turn_error: Option<SoryErrorInfo>,
    completed_at: u64,
...
impl AnalyticsReducer {
    ...
    fn ingest_guardian_review(
        ...
        out.push(TrackEventRequest::GuardianReview(Box::new(
            GuardianReviewEventRequest {
                event_type: "sory_guardian_review",
    ...
    fn ingest_app_mentioned(&mut self, input: AppMentionedInput, out: &mut Vec<TrackEventRequest>) {
        ...
        out.extend(mentions.into_iter().map(|mention| {
            let event_params = sory_app_metadata(&tracking, mention);
            TrackEventRequest::AppMentioned(soryAppMentionedEventRequest {
    ...
    fn ingest_app_used(&mut self, input: AppUsedInput, out: &mut Vec<TrackEventRequest>) {
        ...
        let event_params = sory_app_metadata(&tracking, app);
        out.push(TrackEventRequest::AppUsed(soryAppUsedEventRequest {
    ...
    fn ingest_hook_run(&mut self, input: HookRunInput, out: &mut Vec<TrackEventRequest>) {
        ...
        out.push(TrackEventRequest::HookRun(soryHookRunEventRequest {
            event_type: "sory_hook_run",
            event_params: sory_hook_run_metadata(&tracking, hook),
        }));
    }
    ...
    fn ingest_plugin_used(&mut self, input: PluginUsedInput, out: &mut Vec<TrackEventRequest>) {
        ...
        out.push(TrackEventRequest::PluginUsed(soryPluginUsedEventRequest {
            event_type: "sory_plugin_used",
            event_params: sory_plugin_used_metadata(&tracking, plugin),
        }));
    }
    ...
    fn ingest_plugin_state_changed(
        ...
        let event = soryPluginEventRequest {
            ...
            ServerNotification::TurnCompleted(notification) => {
                ...
                turn_state.completed = Some(CompletedTurnState {
                    ...
                    turn_error: notification
                        .turn
                        .error
                        .and_then(|error| error.sory_error_info),
    ...
    fn ingest_compaction(&mut self, input: soryCompactionEvent, out: &mut Vec<TrackEventRequest>) {
        ...
        out.push(TrackEventRequest::Compaction(Box::new(
            soryCompactionEventRequest {
                event_type: "sory_compaction_event",
                event_params: sory_compaction_event_params(
                    input,
    ...
    fn ingest_guardian_review_completed(
        &mut self,
        notification: sory_app_server_protocol::ItemGuardianApprovalReviewCompletedNotification,
        out: &mut Vec<TrackEventRequest>,
    ) {
    ...
    fn emit_turn_steer_event(
        ...
        out.push(TrackEventRequest::TurnSteer(soryTurnSteerEventRequest {
            event_type: "sory_turn_steer_event",
            event_params: soryTurnSteerEventParams {
    ...
    fn emit_review_event(
        ...
        out.push(TrackEventRequest::ReviewEvent(soryReviewEventRequest {
    ...
    async fn maybe_emit_turn_event(&mut self, turn_id: &str, out: &mut Vec<TrackEventRequest>) {
        ...
        let turn_event = TrackEventRequest::TurnEvent(Box::new(soryTurnEventRequest {
            event_type: "sory_turn_event",
            event_params: sory_turn_event_params(
                connection_state.app_server_client.clone(),
                connection_state.runtime.clone(),
                turn_id.to_string(),
                turn_state,
    ...
    match item {
        ThreadItem::CommandExecution {
            ...
            Some(TrackEventRequest::CommandExecution(
                soryCommandExecutionEventRequest {
        ...
        ThreadItem::FileChange {
            ...
            Some(TrackEventRequest::FileChange(soryFileChangeEventRequest {
                event_type: "sory_file_change_event",
                event_params: soryFileChangeEventParams {
                    base,
        ...
        ThreadItem::McpToolCall {
            ...
            Some(TrackEventRequest::McpToolCall(
                soryMcpToolCallEventRequest {
                    event_type: "sory_mcp_tool_call_event",
                    event_params: soryMcpToolCallEventParams {
                        base,
        ...
        ThreadItem::DynamicToolCall {
            ...
            Some(TrackEventRequest::DynamicToolCall(
                soryDynamicToolCallEventRequest {
                    event_type: "sory_dynamic_tool_call_event",
                    event_params: soryDynamicToolCallEventParams {
                        base,
        ...
        ThreadItem::CollabAgentToolCall {
            ...
            Some(TrackEventRequest::CollabAgentToolCall(
                soryCollabAgentToolCallEventRequest {
                    event_type: "sory_collab_agent_tool_call_event",
                    event_params: soryCollabAgentToolCallEventParams {
                        base,
        ...
        ThreadItem::WebSearch { id, query, action } => {
            ...
            Some(TrackEventRequest::WebSearch(soryWebSearchEventRequest {
                event_type: "sory_web_search_event",
                event_params: soryWebSearchEventParams {
                    base,
        ...
        ThreadItem::ImageGeneration {
            ...
            Some(TrackEventRequest::ImageGeneration(
                soryImageGenerationEventRequest {
                    event_type: "sory_image_generation_event",
                    event_params: soryImageGenerationEventParams {
                        base,
...
fn file_change_counts(changes: &[sory_app_server_protocol::FileUpdateChange]) -> FileChangeCounts {
...
fn analytics_turn_status(status: sory_app_server_protocol::TurnStatus) -> Option<TurnStatus> {
    match status {
        sory_app_server_protocol::TurnStatus::Completed => Some(TurnStatus::Completed),
        sory_app_server_protocol::TurnStatus::Failed => Some(TurnStatus::Failed),
        sory_app_server_protocol::TurnStatus::Interrupted => Some(TurnStatus::Interrupted),
        sory_app_server_protocol::TurnStatus::InProgress => None,
    }
}
