...
use sory_protocol::models::SandboxPermissions;
use sory_protocol::protocol::GuardianAssessmentOutcome;
use sory_protocol::protocol::GuardianCommandSource;
use sory_protocol::protocol::GuardianRiskLevel;
use sory_protocol::protocol::GuardianUserAuthorization;
...
pub(crate) enum TrackEventRequest {
    ...
    AppMentioned(soryAppMentionedEventRequest),
    AppUsed(soryAppUsedEventRequest),
    HookRun(soryHookRunEventRequest),
    Compaction(Box<soryCompactionEventRequest>),
    TurnEvent(Box<soryTurnEventRequest>),
    TurnSteer(soryTurnSteerEventRequest),
    CommandExecution(soryCommandExecutionEventRequest),
    FileChange(soryFileChangeEventRequest),
    McpToolCall(soryMcpToolCallEventRequest),
    DynamicToolCall(soryDynamicToolCallEventRequest),
    CollabAgentToolCall(soryCollabAgentToolCallEventRequest),
    WebSearch(soryWebSearchEventRequest),
    ImageGeneration(soryImageGenerationEventRequest),
    AcceptedLineFingerprints(Box<soryAcceptedLineFingerprintsEventRequest>),
    #[allow(dead_code)]
    ReviewEvent(soryReviewEventRequest),
    PluginUsed(soryPluginUsedEventRequest),
    PluginInstalled(soryPluginEventRequest),
    PluginUninstalled(soryPluginEventRequest),
    PluginEnabled(soryPluginEventRequest),
    PluginDisabled(soryPluginEventRequest),
}
...
#[derive(Serialize)]
pub(crate) struct soryAcceptedLineFingerprintsEventParams {
...
#[derive(Serialize)]
pub(crate) struct soryAcceptedLineFingerprintsEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: soryAcceptedLineFingerprintsEventParams,
}
...
pub(crate) struct soryAppServerClientMetadata {
...
#[derive(Clone, Serialize)]
pub(crate) struct soryRuntimeMetadata {
    pub(crate) sory_rs_version: String,
...
pub(crate) struct ThreadInitializedEventParams {
    pub(crate) thread_id: String,
    pub(crate) app_server_client: soryAppServerClientMetadata,
    pub(crate) runtime: soryRuntimeMetadata,
...
pub enum GuardianApprovalRequestSource {
    /// Approval requested directly by the main sory turn.
    MainTurn,
...
#[derive(Serialize)]
pub(crate) struct soryToolItemEventBase {
    pub(crate) thread_id: String,
    pub(crate) turn_id: String,
...
#[derive(Serialize)]
pub(crate) struct soryReviewEventParams {
    pub(crate) thread_id: String,
    pub(crate) turn_id: String,
...
#[derive(Serialize)]
pub(crate) struct soryReviewEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: soryReviewEventParams,
}
#[allow(dead_code)]
#[derive(Clone, Copy, Debug, Serialize)]
#[serde(rename_all = "snake_case")]
...
#[derive(Serialize)]
pub(crate) struct soryCommandExecutionEventParams {
    #[serde(flatten)]
    pub(crate) base: soryToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct soryCommandExecutionEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: soryCommandExecutionEventParams,
}

#[derive(Serialize)]
pub(crate) struct soryFileChangeEventParams {
    #[serde(flatten)]
    pub(crate) base: soryToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct soryFileChangeEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: soryFileChangeEventParams,
}

#[derive(Serialize)]
pub(crate) struct soryMcpToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: soryToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct soryMcpToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: soryMcpToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct soryDynamicToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: soryToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct soryDynamicToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: soryDynamicToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct soryCollabAgentToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: soryToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct soryCollabAgentToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: soryCollabAgentToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct soryWebSearchEventParams {
    #[serde(flatten)]
    pub(crate) base: soryToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct soryWebSearchEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: soryWebSearchEventParams,
}

#[derive(Serialize)]
pub(crate) struct soryImageGenerationEventParams {
    #[serde(flatten)]
    pub(crate) base: soryToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct soryImageGenerationEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: soryImageGenerationEventParams,
}

#[derive(Serialize)]
pub(crate) struct soryAppMetadata {
...
#[derive(Serialize)]
pub(crate) struct soryAppMentionedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: soryAppMetadata,
}

#[derive(Serialize)]
pub(crate) struct soryAppUsedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: soryAppMetadata,
}

#[derive(Serialize)]
pub(crate) struct soryHookRunMetadata {
    pub(crate) thread_id: Option<String>,
    pub(crate) turn_id: Option<String>,
    pub(crate) model_slug: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct soryHookRunEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: soryHookRunMetadata,
}

#[derive(Serialize)]
pub(crate) struct soryCompactionEventParams {
    pub(crate) thread_id: String,
    pub(crate) turn_id: String,
    pub(crate) app_server_client: soryAppServerClientMetadata,
    pub(crate) runtime: soryRuntimeMetadata,
...
#[derive(Serialize)]
pub(crate) struct soryCompactionEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: soryCompactionEventParams,
}

#[derive(Serialize)]
pub(crate) struct soryTurnEventParams {
    pub(crate) thread_id: String,
    pub(crate) turn_id: String,
    ...
    pub(crate) turn_error: Option<SoryErrorInfo>,
...
#[derive(Serialize)]
pub(crate) struct soryTurnEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: soryTurnEventParams,
}

#[derive(Serialize)]
pub(crate) struct soryTurnSteerEventParams {
    pub(crate) thread_id: String,
...
#[derive(Serialize)]
pub(crate) struct soryTurnSteerEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: soryTurnSteerEventParams,
}

#[derive(Serialize)]
pub(crate) struct soryPluginMetadata {
    pub(crate) plugin_id: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct soryPluginUsedMetadata {
    #[serde(flatten)]
    pub(crate) plugin: soryPluginMetadata,
    pub(crate) thread_id: Option<String>,
    pub(crate) turn_id: Option<String>,
    pub(crate) model_slug: Option<String>,
}
...
#[derive(Serialize)]
pub(crate) struct soryPluginEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: soryPluginMetadata,
}

#[derive(Serialize)]
pub(crate) struct soryPluginUsedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: soryPluginUsedMetadata,
}

pub(crate) fn plugin_state_event_type(state: PluginState) -> &'static str {
    match state {
        PluginState::Installed => "sory_plugin_installed",
        PluginState::Uninstalled => "sory_plugin_uninstalled",
        PluginState::Enabled => "sory_plugin_enabled",
        PluginState::Disabled => "sory_plugin_disabled",
    }
}

pub(crate) fn sory_app_metadata(
...
pub(crate) fn sory_plugin_metadata(plugin: PluginTelemetryMetadata) -> soryPluginMetadata {
...
pub(crate) fn sory_compaction_event_params(
    input: soryCompactionEvent,
    app_server_client: soryAppServerClientMetadata,
    runtime: soryRuntimeMetadata,
    thread_source: Option<ThreadSource>,
    subagent_source: Option<String>,
    parent_thread_id: Option<String>,
) -> soryCompactionEventParams {
    soryCompactionEventParams {
...
pub(crate) fn sory_plugin_used_metadata(
    tracking: &TrackEventsContext,
    plugin: PluginTelemetryMetadata,
) -> soryPluginUsedMetadata {
    soryPluginUsedMetadata {
        plugin: sory_plugin_metadata(plugin),
        thread_id: Some(tracking.thread_id.clone()),
        turn_id: Some(tracking.turn_id.clone()),
        model_slug: Some(tracking.model_slug.clone()),
    }
...
pub(crate) fn sory_hook_run_metadata(
    tracking: &TrackEventsContext,
    hook: HookRunFact,
) -> soryHookRunMetadata {
    soryHookRunMetadata {
...
pub(crate) fn current_runtime_metadata() -> soryRuntimeMetadata {
    let os_info = os_info::get();
    soryRuntimeMetadata {
        sory_rs_version: env!("CARGO_PKG_VERSION").to_string(),
