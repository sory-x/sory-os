...
pub(crate) struct PreToolUseCommandInput {
    ...
    /// sory extension: expose the active turn id to internal turn-scoped hooks.
    pub turn_id: String,
...
mod tests {
    ...
    #[test]
    fn turn_scoped_hook_inputs_include_sory_turn_id_extension() {
        // sory intentionally diverges from Claude's public hook docs here so
