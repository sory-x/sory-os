...
use sory_protocol::protocol::HookTrustStatus;
...
pub(crate) struct ConfiguredHandler {
    pub event_name: sory_protocol::protocol::HookEventName,
...
impl ConfiguredHandler {
    ...
    fn event_name_label(&self) -> &'static str {
        match self.event_name {
            sory_protocol::protocol::HookEventName::PreToolUse => "pre-tool-use",
            sory_protocol::protocol::HookEventName::PermissionRequest => "permission-request",
            sory_protocol::protocol::HookEventName::PostToolUse => "post-tool-use",
            sory_protocol::protocol::HookEventName::PreCompact => "pre-compact",
            sory_protocol::protocol::HookEventName::PostCompact => "post-compact",
            sory_protocol::protocol::HookEventName::SessionStart => "session-start",
            sory_protocol::protocol::HookEventName::UserPromptSubmit => "user-prompt-submit",
            sory_protocol::protocol::HookEventName::Stop => "stop",
        }
    }
}
...
impl ClaudeHooksEngine {
    ...
    async fn maybe_spill_prompt_fragments(
        &self,
        session_id: ThreadId,
        fragments: Vec<sory_protocol::items::HookPromptFragment>,
    ) -> Vec<sory_protocol::items::HookPromptFragment> {
        self.output_spiller
