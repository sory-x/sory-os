...
pub type LoadedPlugin = sory_plugin::LoadedPlugin<sory_config::McpServerConfig>;
pub type PluginLoadOutcome = sory_plugin::PluginLoadOutcome<sory_config::McpServerConfig>;
