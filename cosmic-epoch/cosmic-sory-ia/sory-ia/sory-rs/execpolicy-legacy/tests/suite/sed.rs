extern crate sory_execpolicy_legacy;

use sory_execpolicy_legacy::ArgType;
use sory_execpolicy_legacy::Error;
use sory_execpolicy_legacy::ExecCall;
use sory_execpolicy_legacy::MatchedArg;
use sory_execpolicy_legacy::MatchedExec;
use sory_execpolicy_legacy::MatchedFlag;
use sory_execpolicy_legacy::MatchedOpt;
use sory_execpolicy_legacy::Policy;
use sory_execpolicy_legacy::Result;
use sory_execpolicy_legacy::ValidExec;
use sory_execpolicy_legacy::get_default_policy;
