...
//!
//! RMCP clients call into this module when a server asks sory to elicit data
//! from the user. It decides whether the request can be automatically accepted,
//! must be declined by policy, or should be surfaced as a sory protocol event
...
use sory_protocol::approvals::ElicitationRequest;
...
use sory_rmcp_client::SendElicitation;
