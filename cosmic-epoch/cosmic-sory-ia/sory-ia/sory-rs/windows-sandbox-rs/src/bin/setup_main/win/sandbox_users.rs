...
use sory_windows_sandbox::dpapi_protect;
...
pub const SANDBOX_USERS_GROUP: &str = "sorySandboxUsers";
const SANDBOX_USERS_GROUP_COMMENT: &str = "sory sandbox internal group (managed)";
...
fn write_secrets(
    ...
    let sandbox_dir = sandbox_dir(sory_home);
    ...
    let secrets_dir = sandbox_secrets_dir(sory_home);
