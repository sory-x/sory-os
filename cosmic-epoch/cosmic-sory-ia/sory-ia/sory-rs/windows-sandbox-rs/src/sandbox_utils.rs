...
//! sory home directory creation and git safe.directory injection so sandboxed
...
/// Ensure the sandbox sory home directory exists.
pub fn ensure_sory_home_exists(p: &Path) -> Result<()> {
...
mod tests {
    ...
    fn injects_worktree_root_for_gitfile() {
        ...
        fs::write(
            repo.join(".git"),
            "gitdir: C:/Users/example/repo/.git/worktrees/sory3\n",
        )
