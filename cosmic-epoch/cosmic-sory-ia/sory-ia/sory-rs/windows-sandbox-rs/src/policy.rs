use anyhow::Result;
pub use sory_protocol::protocol::SandboxPolicy;
...
mod tests {
    ...
    fn rejects_external_sandbox_json() {
        let payload =
            serde_json::to_string(&sory_protocol::protocol::SandboxPolicy::ExternalSandbox {
                network_access: sory_protocol::protocol::NetworkAccess::Enabled,
            })
            .unwrap();
