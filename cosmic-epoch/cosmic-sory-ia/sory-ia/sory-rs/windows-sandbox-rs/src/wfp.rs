...
const SESSION_NAME: &str = "sory Windows Sandbox WFP";
const PROVIDER_NAME: &str = "sory Windows Sandbox WFP";
const PROVIDER_DESCRIPTION: &str = "Persistent WFP provider for sory Windows sandbox filters";
const SUBLAYER_NAME: &str = "sory Windows Sandbox WFP";
const SUBLAYER_DESCRIPTION: &str = "Persistent WFP sublayer for sory Windows sandbox filters";

// WFP identifies persistent providers, sublayers, and filters by stable GUIDs.
// These values are sory-owned identities; do not regenerate them unless we
...
/// Installs the persistent sory WFP filters for `account`.
///
...
/// Ensures the persistent sory WFP provider exists.
...
/// Ensures the persistent sory sublayer exists under the sory provider.
