...
use sory_exec_server::ExecServerClient;
use sory_exec_server::RemoteExecServerConnectArgs;
...
fn streamable_http_server_bin() -> Result<PathBuf, CargoBinError> {
    sory_utils_cargo_bin::cargo_bin("test_streamable_http_server")
}
...
fn init_params() -> InitializeRequestParams {
    InitializeRequestParams {
        ...
        client_info: Implementation {
            ...
            title: Some("sory rmcp recovery test".into()),
            description: None,
            icons: None,
            website_url: None,
        },
...
pub(crate) async fn spawn_exec_server() -> anyhow::Result<ExecServerProcess> {
    ...
    let mut child = Command::new(sory_utils_cargo_bin::cargo_bin("sory")?)
...
/// Reads the websocket URL printed by `sory exec-server --listen`.
