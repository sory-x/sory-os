...
mod patch_approval;
mod sory_tool_config;
mod sory_tool_runner;
...
pub use crate::sory_tool_config::soryToolCallParam;
pub use crate::sory_tool_config::soryToolCallReplyParam;
...
const OTEL_SERVICE_NAME: &str = "sory_mcp_server";
...
pub async fn run_main(
    ...
    let environment_manager = Arc::new(
        EnvironmentManager::from_sory_home(
...
mod tests {
    ...
    async fn mcp_server_builds_otel_provider_with_logs_traces_and_metrics() -> anyhow::Result<()> {
        ...
        let provider = sory_core::otel_init::build_provider(
            &config,
            "0.0.0-test",
            Some(OTEL_SERVICE_NAME),
            DEFAULT_ANALYTICS_ENABLED,
