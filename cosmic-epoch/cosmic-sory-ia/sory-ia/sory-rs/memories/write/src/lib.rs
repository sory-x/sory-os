//! Write-path implementation for sory memories.
//!
...
mod guard_limits {
    pub(super) const SORY_LIMIT_ID: &str = "sory";
}
...
mod stage_one {
    ...
    pub(super) const REASONING_EFFORT: sory_protocol::openai_models::ReasoningEffort =
        sory_protocol::openai_models::ReasoningEffort::Low;
...
mod stage_two {
    ...
    pub(super) const REASONING_EFFORT: sory_protocol::openai_models::ReasoningEffort =
        sory_protocol::openai_models::ReasoningEffort::Medium;
    pub(super) const JOB_LEASE_SECONDS: i64 = 3_600;
    pub(super) const JOB_RETRY_DELAY_SECONDS: i64 = 3_600;
