...
//! `EscalateRequest` over the inherited `sory_ESCALATE_SOCKET`, and the server decides whether to
...
//! specified by the `sory_ESCALATE_SOCKET` environment variable to _send_ escalation requests,
...
pub use sory_protocol::approvals::EscalationPermissions;
pub use sory_protocol::approvals::ResolvedPermissionProfile;
