...
//! the fallback bucket.
//!
//! These caps are deliberately conservative: sory is rebuilding normal terminal scrollback, not an
...
use sory_config::types::DEFAULT_TERMINAL_RESIZE_REFLOW_FALLBACK_MAX_ROWS;
