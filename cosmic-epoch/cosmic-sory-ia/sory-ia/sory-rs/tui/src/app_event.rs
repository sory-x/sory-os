...
use sory_realtime_webrtc::RealtimeWebrtcEvent;
use sory_realtime_webrtc::RealtimeWebrtcSessionHandle;
...
pub(crate) enum AppEvent {
    ...
    HooksLoaded {
        cwd: PathBuf,
        result: Result<sory_app_server_protocol::HooksListResponse, String>,
    },
    ...
    /// Persist the selected AI provider to config.
