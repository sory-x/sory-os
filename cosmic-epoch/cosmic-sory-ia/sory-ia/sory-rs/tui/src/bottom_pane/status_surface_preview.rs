...
impl StatusSurfacePreviewItem {
    fn placeholder(self) -> &'static str {
        match self {
            StatusSurfacePreviewItem::AppName => "sory",
            ...
            StatusSurfacePreviewItem::soryVersion => "0.0.0",
            ...
            StatusSurfacePreviewItem::Model => "gpt-5.2-sory",
            StatusSurfacePreviewItem::ModelWithReasoning => "gpt-5.2-sory medium",
