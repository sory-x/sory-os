...
pub(crate) struct ThreadSessionState {
    ...
    pub(crate) approvals_reviewer: sory_protocol::config_types::ApprovalsReviewer,
    ...
    pub(crate) reasoning_effort: Option<sory_protocol::openai_models::ReasoningEffort>,
