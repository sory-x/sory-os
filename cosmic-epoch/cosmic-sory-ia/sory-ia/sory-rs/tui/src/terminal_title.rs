...
//! "leave the old title alone" or "clear the title sory last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title sory manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before sory started managing the title.
