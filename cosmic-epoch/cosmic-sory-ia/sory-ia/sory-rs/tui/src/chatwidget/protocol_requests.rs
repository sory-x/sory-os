...
impl ChatWidget {
    ...
    pub(super) fn on_guardian_review_notification(
        ...
        turn_id: String,
        started_at_ms: i64,
        review: sory_app_server_protocol::GuardianApprovalReview,
        completion: Option<(i64, sory_app_server_protocol::AutoReviewDecisionSource)>,
        ...
        self.on_guardian_assessment(GuardianAssessmentEvent {
            ...
            status: match review.status {
                sory_app_server_protocol::GuardianApprovalReviewStatus::InProgress => {
                    GuardianAssessmentStatus::InProgress
                }
                sory_app_server_protocol::GuardianApprovalReviewStatus::Approved => {
                    GuardianAssessmentStatus::Approved
                }
                sory_app_server_protocol::GuardianApprovalReviewStatus::Denied => {
                    GuardianAssessmentStatus::Denied
                }
                sory_app_server_protocol::GuardianApprovalReviewStatus::TimedOut => {
                    GuardianAssessmentStatus::TimedOut
                }
                sory_app_server_protocol::GuardianApprovalReviewStatus::Aborted => {
                    GuardianAssessmentStatus::Aborted
                }
            },
            risk_level: review.risk_level.map(|risk_level| match risk_level {
                sory_app_server_protocol::GuardianRiskLevel::Low => {
                    sory_protocol::approvals::GuardianRiskLevel::Low
                }
                sory_app_server_protocol::GuardianRiskLevel::Medium => {
                    sory_protocol::approvals::GuardianRiskLevel::Medium
                }
                sory_app_server_protocol::GuardianRiskLevel::High => {
                    sory_protocol::approvals::GuardianRiskLevel::High
                }
                sory_app_server_protocol::GuardianRiskLevel::Critical => {
                    sory_protocol::approvals::GuardianRiskLevel::Critical
                }
            }),
            user_authorization: review.user_authorization.map(|user_authorization| {
                match user_authorization {
                    sory_app_server_protocol::GuardianUserAuthorization::Unknown => {
                        sory_protocol::approvals::GuardianUserAuthorization::Unknown
                    }
                    sory_app_server_protocol::GuardianUserAuthorization::Low => {
                        sory_protocol::approvals::GuardianUserAuthorization::Low
                    }
                    sory_app_server_protocol::GuardianUserAuthorization::Medium => {
                        sory_protocol::approvals::GuardianUserAuthorization::Medium
                    }
                    sory_app_server_protocol::GuardianUserAuthorization::High => {
                        sory_protocol::approvals::GuardianUserAuthorization::High
                    }
                }
            }),
            rationale: review.rationale,
            decision_source: decision_source.map(|source| match source {
                sory_app_server_protocol::AutoReviewDecisionSource::Agent => {
