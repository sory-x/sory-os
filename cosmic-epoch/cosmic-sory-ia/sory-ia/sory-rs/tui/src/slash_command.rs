...
impl SlashCommand {
    ...
    pub fn description(self) -> &'static str {
        match self {
            ...
            SlashCommand::Init => "create an AGENTS.md file with instructions for sory",
            ...
            SlashCommand::Quit | SlashCommand::Exit => "exit sory",
            SlashCommand::Copy => "copy last response as markdown",
            SlashCommand::Raw => "toggle raw scrollback mode for copy-friendly terminal selection",
            SlashCommand::Diff => "show git diff (including untracked files)",
            SlashCommand::Mention => "mention a file",
            SlashCommand::Skills => "use skills to improve how sory performs specific tasks",
            ...
            SlashCommand::Provider => "choose what AI provider to use",
            SlashCommand::Ide => {
                "include current selection, open files, and other context from your IDE"
            }
            SlashCommand::Personality => "choose a communication style for sory",
            ...
            SlashCommand::Permissions => "choose what sory is allowed to do",
            ...
            SlashCommand::Logout => "log out of sory",
