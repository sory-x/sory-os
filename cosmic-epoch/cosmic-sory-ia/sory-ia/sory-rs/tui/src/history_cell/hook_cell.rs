...
use sory_app_server_protocol::HookOutputEntry;
use sory_app_server_protocol::HookOutputEntryKind;
use sory_app_server_protocol::HookRunStatus;
use sory_app_server_protocol::HookRunSummary;
use ratatui::prelude::*;
