...
impl ThreadEventStore {
    ...
    pub(super) fn file_change_changes(
        ...
        turn_id: &str,
        item_id: &str,
    ) -> Option<Vec<sory_app_server_protocol::FileUpdateChange>> {
        self.buffer
            .iter()
            .rev()
...
mod tests {
    ...
    use sory_app_server_protocol::HookEventName as AppServerHookEventName;
    use sory_app_server_protocol::HookExecutionMode as AppServerHookExecutionMode;
    use sory_app_server_protocol::HookHandlerType as AppServerHookHandlerType;
    use sory_app_server_protocol::HookOutputEntry as AppServerHookOutputEntry;
    use sory_app_server_protocol::HookOutputEntryKind as AppServerHookOutputEntryKind;
    use sory_app_server_protocol::HookRunStatus as AppServerHookRunStatus;
    use sory_app_server_protocol::HookRunSummary as AppServerHookRunSummary;
    use sory_app_server_protocol::HookScope as AppServerHookScope;
