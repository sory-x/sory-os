...
pub(super) async fn send_add_credits_nudge_email(
    request_handle: AppServerRequestHandle,
    credit_type: AddCreditsNudgeCreditType,
) -> Result<sory_app_server_protocol::AddCreditsNudgeEmailStatus> {
    let request_id = RequestId::String(format!("add-credits-nudge-{}", Uuid::new_v4()));
    let response: sory_app_server_protocol::SendAddCreditsNudgeEmailResponse = request_handle
    ...
    request_handle
        .request_typed(ClientRequest::ConfigBatchWrite {
            ...
            params: ConfigBatchWriteParams {
                edits: vec![sory_app_server_protocol::ConfigEdit {
...
pub(super) type McpInventoryMaps = (
    HashMap<String, sory_protocol::mcp::Tool>,
    HashMap<String, Vec<sory_protocol::mcp::Resource>>,
    HashMap<String, Vec<sory_protocol::mcp::ResourceTemplate>>,
    ...
    for status in statuses {
        ...
        auth_statuses.insert(
            ...
            match status.auth_status {
                sory_app_server_protocol::McpAuthStatus::Unsupported => McpAuthStatus::Unsupported,
                sory_app_server_protocol::McpAuthStatus::NotLoggedIn => McpAuthStatus::NotLoggedIn,
                sory_app_server_protocol::McpAuthStatus::BearerToken => McpAuthStatus::BearerToken,
                sory_app_server_protocol::McpAuthStatus::OAuth => McpAuthStatus::OAuth,
            },
        );
