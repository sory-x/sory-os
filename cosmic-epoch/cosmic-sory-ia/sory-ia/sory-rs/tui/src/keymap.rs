...
use sory_config::types::KeybindingsSpec;
...
Set unique keys in `~/.sory/config.toml` and retry. \
...
Set a different key in `~/.sory/config.toml` and retry. \
See the sory keymap documentation for supported actions and examples."
                ));
            }
        }
...
mod tests {
    use super::*;
    use sory_config::types::KeybindingSpec;
