...
fn live_001_commit_on_overflow() {
    ...
    let mut term = match sory_tui::Terminal::with_options(backend) {
        Ok(t) => t,
    ...
    let mut rb = sory_tui::RowBuilder::new(/*target_width*/ 20);
    ...
    sory_tui::insert_history_lines(&mut term, lines)
