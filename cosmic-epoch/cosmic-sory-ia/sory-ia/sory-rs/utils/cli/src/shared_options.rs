//! Shared command-line flags used by both interactive and non-interactive sory entry points.

use crate::SandboxModeCliArg;
use clap::Args;
use sory_protocol::config_types::ProfileV2Name;
...
pub struct SharedCliOptions {
    ...
    /// Layer $sory_HOME/<name>.config.toml on top of the base user config.
    #[arg(long = "profile-v2")]
