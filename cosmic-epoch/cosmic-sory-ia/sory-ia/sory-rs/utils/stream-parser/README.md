# sory-utils-stream-parser

Small, dependency-free utilities for parsing streamed text incrementally.

**Disclaimer**: This code is pretty complex and sory did not manage to write it so before updating the code, make
sure to deeply understand it and don't blindly trust sory on it. Feel free to update the documentation as you
modify the code
...
```rust
use sory_utils_stream_parser::CitationStreamParser;
use sory_utils_stream_parser::StreamTextParser;
...
```rust
use sory_utils_stream_parser::CitationStreamParser;
use sory_utils_stream_parser::Utf8StreamParser;

# fn demo() -> Result<(), sory_utils_stream_parser::Utf8StreamParserError> {
...
```rust
use sory_utils_stream_parser::InlineHiddenTagParser;
use sory_utils_stream_parser::InlineTagSpec;
use sory_utils_stream_parser::StreamTextParser;
