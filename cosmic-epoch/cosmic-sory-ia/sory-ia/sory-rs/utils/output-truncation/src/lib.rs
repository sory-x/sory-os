//! Helpers for truncating tool and exec output using [`TruncationPolicy`](sory_protocol::protocol::TruncationPolicy).

use sory_protocol::models::FunctionCallOutputContentItem;
pub use sory_utils_string::approx_bytes_for_tokens;
pub use sory_utils_string::approx_token_count;
pub use sory_utils_string::approx_tokens_from_byte_count;
use sory_utils_string::truncate_middle_chars;
use sory_utils_string::truncate_middle_with_token_budget;

pub use sory_protocol::protocol::TruncationPolicy;
