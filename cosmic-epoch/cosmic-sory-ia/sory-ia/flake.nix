{
  description = "Development Nix flake for OpenAI sory CLI";
  ...
  outputs = { self, nixpkgs, rust-overlay, ... }:
    let
      ...
      cargoToml = builtins.fromTOML (builtins.readFile ./sory-rs/Cargo.toml);
    ...
    in
    {
      packages = forAllSystems (system:
        let
          ...
          sory-rs-internal = pkgs.callPackage ./sory-rs {
            inherit version;
        ...
        in
        {
          sory-rs-internal = sory-rs-internal;
          default = sory-rs-internal;
        }
      );
