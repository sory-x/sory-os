...
from openai_sory import AppServerConfig
...
class AppServerHarness:
    ...
    def __init__(self, tmp_path: Path, *, requires_openai_auth: bool = False) -> None:
        ...
        self.sory_home = tmp_path / "sory-home"
    ...
    def __exit__(self, _exc_type: object, _exc: object, _tb: object) -> None:
        ...
        shutil.rmtree(self.sory_home, ignore_errors=True)
    ...
    def app_server_config(self) -> AppServerConfig:
        ...
        return AppServerConfig(
            ...
            env={
                "sory_HOME": str(self.sory_home),
                "sory_APP_SERVER_DISABLE_MANAGED_CONFIG": "1",
                "RUST_LOG": "warn",
            },
        )
    ...
    def _write_config(self) -> None:
        ...
        config_toml = self.sory_home / "config.toml"
