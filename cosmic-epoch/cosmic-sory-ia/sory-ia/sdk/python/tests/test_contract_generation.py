...
GENERATED_TARGETS = [
    Path("src/openai_sory/generated/notification_registry.py"),
    Path("src/openai_sory/generated/v2_all.py"),
    Path("src/openai_sory/api.py"),
]
...
def test_generated_files_are_up_to_date():
    ...
    assert importlib.metadata.version("openai-sory-cli-bin") == "0.131.0a4"
    env = os.environ.copy()
    env.pop("sory_EXEC_PATH", None)
