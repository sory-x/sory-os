...
RUN_REAL_sory_TESTS = os.environ.get("RUN_REAL_sory_TESTS") == "1"
pytestmark = pytest.mark.skipif(
    not RUN_REAL_sory_TESTS,
    reason="set RUN_REAL_sory_TESTS=1 to run real sory integration coverage",
)
...
def runtime_env(tmp_path_factory: pytest.TempPathFactory) -> PreparedRuntimeEnv:
    ...
    env["sory_PYTHON_SDK_DIR"] = str(ROOT)
