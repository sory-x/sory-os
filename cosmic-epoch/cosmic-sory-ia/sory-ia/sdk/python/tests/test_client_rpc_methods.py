...
from openai_sory.client import AppServerClient, _params_dict
from openai_sory.generated.notification_registry import notification_turn_id
...
from openai_sory.models import Notification, UnknownNotification
...
def test_generated_v2_bundle_has_single_shared_plan_type_definition() -> None:
    source = (ROOT / "src" / "openai_sory" / "generated" / "v2_all.py").read_text()
