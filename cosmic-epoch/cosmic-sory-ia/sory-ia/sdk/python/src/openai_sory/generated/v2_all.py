...
#   filename:  sory_app_server_protocol.v2.schemas.json
...
class soryAppServerProtocolV2(BaseModel):
    pass
...
class HttpConnectionFailedsoryErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseStreamConnectionFailedsoryErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseStreamDisconnectedsoryErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseTooManyFailedAttemptssoryErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ProjectConfigLayerSource(BaseModel):
    ...
    dot_sory_folder: Annotated[AbsolutePathBuf, Field(alias="dotsoryFolder")]
...
class ExternalAgentConfigDetectParams(BaseModel):
    ...
    include_home: Annotated[
        ...
        Field(
            alias="includeHome",
            description="If true, include detection under the user's home (~/.claude, ~/.sory, etc.).",
        ),
    ] = None
...
class ChatgptLoginAccountParams(BaseModel):
    ...
    sory_streamlined_login: Annotated[bool | None, Field(alias="soryStreamlinedLogin")] = None
...
class ChatgptAuthTokensLoginAccountParams(BaseModel):
    ...
    chatgpt_plan_type: Annotated[
        ...
        Field(
            ...
            description="Optional plan type supplied by the client.\n\nWhen `null`, sory attempts to derive the plan type from access-token claims. If unavailable, the plan defaults to `unknown`.",
        ),
    ] = None
    type: Annotated[
...
class ThreadApproveGuardianDeniedActionParams(BaseModel):
    ...
    event: Annotated[
        Any, Field(description="Serialized `sory_protocol::protocol::GuardianAssessmentEvent`.")
    ]
    thread_id: Annotated[str, Field(alias="threadId")]
...
class ActiveTurnNotSteerablesoryErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class soryErrorInfo(
    RootModel[
        soryErrorInfoValue
        | HttpConnectionFailedsoryErrorInfo
        | ResponseStreamConnectionFailedsoryErrorInfo
        | ResponseStreamDisconnectedsoryErrorInfo
        | ResponseTooManyFailedAttemptssoryErrorInfo
        | ActiveTurnNotSteerablesoryErrorInfo
    ]
):
    model_config = ConfigDict(
        populate_by_name=True,
...
class TurnError(BaseModel):
    ...
    sory_error_info: Annotated[soryErrorInfo | None, Field(alias="soryErrorInfo")] = None
    message: str
...
class GetAccountRateLimitsResponse(BaseModel):
    ...
    rate_limits_by_limit_id: Annotated[
        ...
        Field(
            ...
            description="Multi-bucket view keyed by metered `limit_id` (for example, `sory`).",
        ),
    ] = None
...
class Thread(BaseModel):
    ...
    source: Annotated[
        SessionSource,
        Field(
            description="Origin of the thread (CLI, VSCode, sory exec, sory app-server, etc.)."
        ),
    ]
