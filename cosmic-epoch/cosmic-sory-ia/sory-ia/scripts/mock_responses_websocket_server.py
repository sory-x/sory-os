...
async def _handle_connection(
    ...
    *,
    ...
    # Request 1: provoke a function call (mirrors `sory-rs/core/tests/suite/agent_websocket.rs`).
...
start sory with `sory --profile localapi_ws`
""")
    sys.stdout.flush()
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Mock a minimal Responses API WebSocket endpoint for the `test_sory` flow.\n"
