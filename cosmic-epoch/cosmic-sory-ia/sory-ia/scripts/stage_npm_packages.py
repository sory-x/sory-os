#!/usr/bin/env python3
"""Stage one or more sory npm packages for release."""
...
BUILD_SCRIPT = REPO_ROOT / "sory-cli" / "scripts" / "build_npm_package.py"
INSTALL_NATIVE_DEPS = REPO_ROOT / "sory-cli" / "scripts" / "install_native_deps.py"
WORKFLOW_NAME = ".github/workflows/rust-release.yml"
GITHUB_REPO = "openai/sory"

_SPEC = importlib.util.spec_from_file_location("sory_build_npm_package", BUILD_SCRIPT)
...
sory_PLATFORM_PACKAGES = getattr(_BUILD_MODULE, "sory_PLATFORM_PACKAGES", {})
...
def tarball_name_for_package(package: str, version: str) -> str:
    if package in sory_PLATFORM_PACKAGES:
        platform = package.removeprefix("sory-")
        return f"sory-npm-{platform}-{version}.tgz"
