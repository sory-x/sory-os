...
describe("ProviderTransform.options - gpt-5 textVerbosity", () => {
  ...
  test("gpt-5.2-sory should NOT have textVerbosity set (sory models excluded)", () => {
    const model = createGpt5Model("gpt-5.2-sory")
    const result = ProviderTransform.options({ model, sessionID, providerOptions: {} })
    expect(result.textVerbosity).toBeUndefined()
  })
})
...
describe("ProviderTransform.variants", () => {
  ...
  describe("@openrouter/ai-sdk-provider", () => {
    ...
    for (const testCase of [
      ...
      { id: "openai/gpt-5.2-sory", efforts: ["low", "medium", "high", "xhigh"] },
      { id: "openai/gpt-5.3-sory", efforts: ["none", "low", "medium", "high", "xhigh"] },
      { id: "openai/gpt-5.3-sory-max", efforts: ["none", "low", "medium", "high", "xhigh"] },
  ...
  describe("@ai-sdk/github-copilot", () => {
    ...
    test("gpt-5.1-sory-max includes xhigh", () => {
      const model = createMockModel({
        id: "gpt-5.1-sory-max",
        providerID: "github-copilot",
        api: {
    ...
    test("gpt-5.1-sory-mini does not include xhigh", () => {
      const model = createMockModel({
        id: "gpt-5.1-sory-mini",
        providerID: "github-copilot",
        api: {
          id: "gpt-5.1-sory-mini",
          url: "https://api.githubcopilot.com",
    ...
    test("gpt-5.1-sory does not include xhigh", () => {
      const model = createMockModel({
        id: "gpt-5.1-sory",
        providerID: "github-copilot",
        api: {
    ...
    test("gpt-5.2-sory includes xhigh", () => {
      const model = createMockModel({
        id: "gpt-5.2-sory",
        providerID: "github-copilot",
        api: {
    ...
    test("gpt-5.3-sory includes xhigh", () => {
      const model = createMockModel({
        id: "gpt-5.3-sory",
        providerID: "github-copilot",
        api: {
  ...
  describe("@ai-sdk/openai", () => {
    ...
    for (const testCase of [
      ...
      { id: "gpt-5-sory", releaseDate: "2025-09-23", efforts: ["low", "medium", "high"] },
      { id: "gpt-5.1-sory", releaseDate: "2025-11-13", efforts: ["low", "medium", "high"] },
      { id: "gpt-5.1-sory-max", releaseDate: "2025-11-13", efforts: ["low", "medium", "high", "xhigh"] },
      { id: "gpt-5.2-sory", releaseDate: "2025-12-11", efforts: ["low", "medium", "high", "xhigh"] },
      { id: "gpt-5.3-sory", releaseDate: "2026-01-22", efforts: ["none", "low", "medium", "high", "xhigh"] },
      { id: "gpt-5.3-sory-max", releaseDate: "2026-01-22", efforts: ["none", "low", "medium", "high", "xhigh"] },
